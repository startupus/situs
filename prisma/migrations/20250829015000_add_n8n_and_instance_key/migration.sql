...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "admin_screens_projectId_alias_key" ON "admin_screens"("projectId", "alias");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "admin_screens_projectId_path_key" ON "admin_screens"("projectId", "path");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "web_categories_productId_slug_key" ON "web_categories"("productId", "slug");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "integrations_projectId_idx" ON "integrations"("projectId");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "integrations_projectId_provider_instanceKey_key" ON "integrations"("projectId", "provider", "instanceKey");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "integration_events_integrationId_idx" ON "integration_events"("integrationId");
