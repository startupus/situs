...
// Иконки для меню
import { FiHome, FiBriefcase, FiShoppingCart, FiMessageCircle, FiTrendingUp, FiUsers, FiUser, FiSliders, FiGlobe, FiSmartphone, FiZap, FiPackage, FiMail, FiBarChart, FiTarget, FiShare2 } from 'react-icons/fi';
...
class SitusMenuRegistry {
    ...
    createPlaceholderComponent(title, description) {
        return () => (_jsxs("div", { className: "p-6", children: [_jsx("h1", { className: "text-2xl font-semibold text-dark dark:text-white", children: title }), _jsx("p", { className: "text-body-color dark:text-dark-6 mt-2", children: description })] }));
    }
    addSection(section) {
...
//# sourceMappingURL=MenuRegistry.js.map