...
vi.mock('react-apexcharts', () => ({
    default: ({ options, series, type, height }) => (_jsx("div", { "data-testid": "apex-chart", "data-type": type, "data-height": height, children: "Chart Component" })),
}));
describe('ProjectOrdersChart', () => {
    it('рендерит график заказов с правильными данными', () => {
        render(_jsx(ProjectOrdersChart, { data: projectOrdersData }));
...
describe('ProjectTrafficChart', () => {
    it('рендерит график посещаемости с правильными данными', () => {
        render(_jsx(ProjectTrafficChart, { data: projectTrafficData, timeLabels: timeLabels }));
...
describe('ProjectConversionWidget', () => {
    it('рендерит виджет конверсии с правильными данными', () => {
        render(_jsx(ProjectConversionWidget, { projects: projectConversionData }));
...
//# sourceMappingURL=dashboard-components.test.js.map