...
const SitusWebsites = () => {
    ...
    const filteredWebsites = mockWebsites.filter(website => website.name.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    return (_jsxs("div", { className: "flex", children: [_jsx(ProjectsSidebar, {}), _jsxs("div", { className: "flex-1 p-6", children: [_jsxs("div", { className: "mb-8", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-semibold text-dark dark:text-white", children: "\u0421\u0430\u0439\u0442\u044B" }), _jsx("p", { className: "text-body-color dark:text-dark-6 mt-2", children: "\u0423\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0432\u0435\u0431-\u0441\u0430\u0439\u0442\u0430\u043C\u0438 \u0438 \u043B\u0435\u043D\u0434\u0438\u043D\u0433\u0430\u043C\u0438" })] }), _jsxs(Link, { to: "/projects/new?type=website", className: "inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 transition-colors", children: [_jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", className: "fill-current", children: _jsx("path", { d: "M8 1C8.55228 1 9 1.44772 9 2V7H14C14.5523 7 15 7.44772 15 8C15 8.55228 14.5523 9 14 9H9V14C9 14.5523 8.55228 15 8 15C7.44772 15 7 14.5523 7 14V9H2C1.44772 9 1 8.55228 1 8C1 7.44772 1.44772 7 2 7H7V2C7 1.44772 7.44772 1 8 1Z" }) }), "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0441\u0430\u0439\u0442"] })] }), _jsx("div", { className: "mt-6", children: _jsxs("div", { className: "relative max-w-md", children: [_jsx("input", { type: "text", placeholder: "\u041F\u043E\u0438\u0441\u043A \u0441\u0430\u0439\u0442\u043E\u0432...", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "w-full rounded-lg border border-stroke bg-transparent px-4 py-3 pl-10 text-body-color placeholder-body-color outline-none transition focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-white dark:placeholder-dark-6" }), _jsx("svg", { width: "20", height: "20", viewBox: "0 0 20 20", className: "fill-current absolute left-3 top-1/2 -translate-y-1/2 text-body-color dark:text-dark-6", children: _jsx("path", { d: "M8 4C5.79086 4 4 5.79086 4 8C4 10.2091 5.79086 12 8 12C10.2091 12 12 10.2091 12 8C12 5.79086 10.2091 4 8 4ZM2 8C2 4.68629 4.68629 2 8 2C11.3137 2 14 4.68629 14 8C14 9.29583 13.5892 10.4957 12.8907 11.4765L17.7071 16.2929C18.0976 16.6834 18.0976 17.3166 17.7071 17.7071C17.3166 18.0976 16.6834 18.0976 16.2929 17.7071L11.4765 12.8907C10.4957 13.5892 9.29583 14 8 14C4.68629 14 2 11.3137 2 8Z" }) })] }) })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: filteredWebsites.map((website) => (_jsxs("div", { className: "bg-white dark:bg-dark-2 rounded-lg border border-stroke dark:border-dark-3 p-6 hover:shadow-lg transition-shadow", children: [_jsxs("div", { className: "flex items-start justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex-shrink-0", children: _jsxs("svg", { width: "24", height: "24", viewBox: "0 0 24 24", className: "fill-current text-blue-500", children: [_jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20Z" }), _jsx("path", { d: "M7 7H17V9H7V7ZM7 11H17V13H7V11ZM7 15H13V17H7V15Z" })] }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-dark dark:text-white text-sm", children: website.name }), _jsx("p", { className: "text-xs text-body-color dark:text-dark-6", children: website.template })] })] }), getStatusBadge(website.status)] }), _jsx("div", { className: "mb-4", children: _jsx("a", { href: website.url, target: "_blank", rel: "noopener noreferrer", className: "text-primary hover:text-primary/80 text-sm break-all", children: website.url }) }), _jsxs("div", { className: "grid grid-cols-2 gap-4 mb-4", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-lg font-semibold text-dark dark:text-white", children: website.visitors.toLocaleString() }), _jsx("div", { className: "text-xs text-body-color dark:text-dark-6", children: "\u041F\u043E\u0441\u0435\u0442\u0438\u0442\u0435\u043B\u0438" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "text-lg font-semibold text-dark dark:text-white", children: website.pages }), _jsx("div", { className: "text-xs text-body-color dark:text-dark-6", children: "\u0421\u0442\u0440\u0430\u043D\u0438\u0446" })] })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Link, { to: `/projects/${website.id}/edit`, className: "flex-1 text-center px-3 py-2 text-sm font-medium text-primary border border-primary rounded-lg hover:bg-primary hover:text-white transition-colors", children: "\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C" }), _jsx(Link, { to: `/projects/${website.id}/preview`, className: "flex-1 text-center px-3 py-2 text-sm font-medium text-body-color border border-stroke dark:border-dark-3 rounded-lg hover:bg-gray-50 dark:hover:bg-dark-3 transition-colors", children: "\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440" })] })] }, website.id))) }), filteredWebsites.length === 0 && (_jsxs("div", { className: "text-center py-12", children: [_jsxs("svg", { width: "64", height: "64", viewBox: "0 0 64 64", className: "fill-current text-gray-400 dark:text-dark-6 mx-auto mb-4", children: [_jsx("path", { d: "M32 8C18.745 8 8 18.745 8 32C8 45.255 18.745 56 32 56C45.255 56 56 45.255 56 32C56 18.745 45.255 8 32 8ZM32 52C21.177 52 12 42.823 12 32C12 21.177 21.177 12 32 12C42.823 12 52 21.177 52 32C52 42.823 42.823 52 32 52Z" }), _jsx("path", { d: "M32 20C25.373 20 20 25.373 20 32C20 38.627 25.373 44 32 44C38.627 44 44 38.627 44 32C44 25.373 38.627 20 32 20ZM32 40C27.589 40 24 36.411 24 32C24 27.589 27.589 24 32 24C36.411 24 40 27.589 40 32C40 36.411 36.411 40 32 40Z" })] }), _jsx("h3", { className: "text-lg font-semibold text-dark dark:text-white mb-2", children: "\u0421\u0430\u0439\u0442\u044B \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B" }), _jsx("p", { className: "text-body-color dark:text-dark-6 mb-4", children: searchTerm
                                    ? "Попробуйте изменить поисковый запрос"
                                    : "Создайте свой первый сайт" }), !searchTerm && (_jsxs(Link, { to: "/projects/new?type=website", className: "inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 transition-colors", children: [_jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", className: "fill-current", children: _jsx("path", { d: "M8 1C8.55228 1 9 1.44772 9 2V7H14C14.5523 7 15 7.44772 15 8C15 8.55228 14.5523 9 14 9H9V14C9 14.5523 8.55228 15 8 15C7.44772 15 7 14.5523 7 14V9H2C1.44772 9 1 8.55228 1 8C1 7.44772 1.44772 7 2 7H7V2C7 1.44772 7.44772 1 8 1Z" }) }), "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0441\u0430\u0439\u0442"] }))] }))] })] }));
};
export default SitusWebsites;
//# sourceMappingURL=SitusWebsites.js.map