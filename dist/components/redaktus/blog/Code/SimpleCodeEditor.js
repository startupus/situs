...
const isMacLike = typeof window != 'undefined' &&
...
export default class Editor extends React.Component {
    ...
    render() {
        const { value, style, padding, highlight, textareaId, textareaClassName, autoFocus, disabled, form, maxLength, minLength, name, placeholder, readOnly, required, onClick, onFocus, onBlur, onKeyUp, 
        /* eslint-disable no-unused-vars */
        onKeyDown, onValueChange, tabSize, insertSpaces, ignoreTabKey, 
        /* eslint-enable no-unused-vars */
        preClassName, } = this.props;
        const contentStyle = {
            paddingTop: padding,
        ...
        return (_jsxs("div", { style: { ...styles.container, ...style }, children: [_jsx("textarea", { ref: (c) => (this._input = c), style: { ...styles.editor, ...styles.textarea, ...contentStyle }, className: className + (textareaClassName ? ` ${textareaClassName}` : ''), id: textareaId, value: value, onChange: this._handleChange, onKeyDown: this._handleKeyDown, onClick: onClick, onKeyUp: onKeyUp, onFocus: onFocus, onBlur: onBlur, disabled: disabled, form: form, maxLength: maxLength, minLength: minLength, name: name, placeholder: placeholder, readOnly: readOnly, required: required, autoFocus: autoFocus, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", spellCheck: false, "data-gramm": false }), _jsx("pre", { className: preClassName, "aria-hidden": "true", style: { ...styles.editor, ...styles.highlight, ...contentStyle }, ...(typeof highlighted === 'string'
                        ? {
                        ...
                        }) }), _jsx("style", { type: "text/css", dangerouslySetInnerHTML: {
                        __html: cssText,
                    } })] }));
    }
}
...
//# sourceMappingURL=SimpleCodeEditor.js.map