...
export { Badge, Button, BulletListItem, HeroUnit, TextImage, TextImageLogo, Testimonial, Customers, Customer, Faqs, Faq, CallToAction, Map, BigFeature, NewsletterSubscribe, Team, TeamItem, Features, FeatureItem, ImageCarousel, SingleImage, Video, HorizontalRule, Spacer, 
// Document,
// Documents,
FormBuilder, FormButton, FormCheckbox, FormInput, FormSelect, FormRadiobuttons, FormSingleRadio, FormTextarea, Table, TableRow, TableCell, };
const allBricks = [
    Badge,
    Button,
    BulletListItem,
