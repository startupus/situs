...
import { FaChevronDown, FaPlay, FaCog, FaEye, FaClock, FaTag, FaSearch, FaSave, FaTrash, FaCube, FaFile, FaCogs, FaStar, FaParagraph, FaComments } from 'react-icons/fa';
const SettingsPanel = ({ currentPage = "Home" }) => {
    ...
    return (_jsx("div", { className: "redaktus-settings-panel w-80 flex-shrink-0 overflow-y-auto transition-colors duration-200 bg-gray-100 border-gray-200 dark:bg-gray-800 dark:border-gray-700 border-l h-full", children: _jsxs("div", { className: "bg-gray-100 dark:bg-gray-800 h-full flex flex-col", children: [_jsx("div", { className: "border-b border-gray-200 bg-gray-100 dark:border-gray-700 dark:bg-gray-800 flex-shrink-0", children: _jsxs("nav", { className: "flex", children: [_jsx("div", { onClick: () => setActiveTab('page'), className: `flex-1 px-3 py-3 text-sm cursor-pointer transition-colors ${activeTab === 'page'
                                    ...
                                    : 'text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`, children: "Page" }), _jsx("div", { onClick: () => setActiveTab('blocks'), className: `flex-1 px-3 py-3 text-sm cursor-pointer transition-colors ${activeTab === 'blocks'
                                    ? 'text-gray-700 font-semibold border-b-2 border-gray-700 dark:text-gray-100 dark:border-gray-100'
                                    : 'text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`, children: "Blocks" }), _jsx("div", { onClick: () => setActiveTab('item'), className: `flex-1 px-3 py-3 text-sm cursor-pointer transition-colors ${activeTab === 'item'
                                    ? 'text-gray-700 font-semibold border-b-2 border-gray-700 dark:text-gray-100 dark:border-gray-100'
                                    : 'text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`, children: "Item" })] }) }), _jsxs("div", { className: "p-6 flex-1 overflow-y-auto", children: [activeTab === 'page' && _jsx(PageTab, { currentPage: currentPage }), activeTab === 'blocks' && _jsx(BlocksTab, {}), activeTab === 'item' && _jsx(ItemTab, {})] })] }) }));
};
// Вкладка Page - настройки страницы
const PageTab = ({ currentPage }) => {
    return (_jsxs("div", { children: [_jsxs("div", { className: "mb-6", children: [_jsx("h3", { className: "text-lg font-semibold transition-colors duration-200 text-gray-800 dark:text-gray-100", children: "Page Settings" }), _jsx("p", { className: "text-sm mt-1 transition-colors duration-200 text-gray-500 dark:text-gray-400", children: "Configure page properties and SEO" })] }), _jsx(SettingsSection, { title: "Status and Visibility", icon: _jsx(FaEye, { size: 16 }), collapsible: true, children: _jsxs("div", { className: "space-y-4", children: [_jsx(InputGroup, { label: "VISIBILITY", type: "select", value: "Published", options: ['Published', 'Draft', 'Private'] }), _jsxs("div", { className: "flex items-center justify-between p-3 rounded-lg border bg-green-50 border-green-200 text-green-700 dark:bg-green-900/20 dark:border-green-700 dark:text-green-300", children: [_jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("div", { className: "w-2 h-2 bg-green-500 rounded-full" }), _jsx("span", { className: "text-sm font-medium", children: "Published Live" })] }), _jsx(FaPlay, { size: 12 })] })] }) }), _jsx(SettingsSection, { title: "Schedule Publish", icon: _jsx(FaClock, { size: 16 }), collapsible: true, children: _jsxs("div", { className: "space-y-4", children: [_jsx(InputGroup, { label: "PUBLISH DATE", type: "date", value: "21.01.2025" }), _jsx(InputGroup, { label: "PUBLISH TIME", type: "time", value: "00:00" })] }) }), _jsx(SettingsSection, { title: "Page Structure", icon: _jsx(FaCogs, { size: 16 }), collapsible: true, children: _jsxs("div", { className: "space-y-4", children: [_jsx(InputGroup, { label: "STRUCTURE LOCKED?", type: "select", value: "Unlocked", options: ['Unlocked', 'Locked'] }), _jsx("p", { className: "text-sm transition-colors duration-200 text-gray-500 dark:text-gray-400", children: "When locked, the page structure cannot be modified by content editors" })] }) }), _jsx(SettingsSection, { title: "Page Attributes", icon: _jsx(FaTag, { size: 16 }), collapsible: true, children: _jsx("div", { className: "space-y-4", children: _jsx(InputGroup, { label: "PAGE SLUG", type: "text", value: "/home", placeholder: "Enter page slug" }) }) })] }));
};
