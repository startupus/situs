 ...
 */
export const Require = (permission: Permission) => SetMetadata(PERMISSION_KEY, permission);
 ...
 */
export const AnyPermission = (permissions: Permission[]) => SetMetadata(PERMISSION_KEY, { type: 'any', permissions });
 ...
 */
export const RequireAll = (permissions: Permission[]) => SetMetadata(PERMISSION_KEY, { type: 'all', permissions });
