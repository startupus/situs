      ...
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[500px] rounded-lg border border-stroke bg-white px-5 pb-5 pt-[30px] dark:border-dark-3 dark:bg-dark-2 sm:px-[30px]">
          <div className="flex justify-between">
            <div>
              <h5 className="text-sm font-semibold text-dark dark:text-white">Conversion Details</h5>
              <p className="text-xs text-body-color dark:text-dark-6">your total sales data analytics</p>
            </div>
            <div>
              <Dropdown />
            </div>
