      ...
      <section className="relative flex min-h-screen w-full items-start bg-gray">
        ...
        <div className="relative z-50 ml-0 w-full xl:ml-[300px]">
          ...
          <header className="w-full bg-white">
            <HorizontalMenu title="Hello user!" subtitle="Welcome back to dashboard.">
              <NavRight
          ...
          <div className="p-[30px]">
            ...
            <div className="-mx-5 flex flex-wrap">
              ...
              >
                <InputGroup labelTitle="First Name" type="text" value="Musharof" placeholder="Musharof" />
                <InputGroup labelTitle="Last Name" type="text" value="Chy" placeholder="Chy" />
                <InputGroup
              ...
              <RightColumn title="Password">
                <InputGroup labelTitle="Current Password" type="password" value="" placeholder="***********" />
                <InputGroup labelTitle="New Password" type="password" value="" placeholder="Enter your new password" />
                <InputGroup
