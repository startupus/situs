...
const Week = ({ name }) => {
  return <span className="flex h-[38px] w-[38px] items-center justify-center sm:h-[46px] sm:w-[47px]">{name}</span>;
};

const DayRow = ({ children }) => {
  return <div className="flex justify-between pb-2 text-sm font-medium sm:text-lg">{children}</div>;
};
