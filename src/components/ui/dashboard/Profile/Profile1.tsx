            ...
            <div className="w-full md:pl-6">
              <div className="mb-6 items-center justify-between sm:flex">
                <div className="mb-8 sm:mb-0">
                  <h4 className="mb-1.5 text-2xl font-bold text-dark dark:text-white">Danish Hebo</h4>
                  <p className="text-sm font-medium text-body-color dark:text-dark-6">Professional Ui/Ux Designer</p>
                </div>
                <div>
                  <p className="mb-2 text-sm font-medium text-body-color dark:text-dark-6">Follow me on</p>
              ...
              <div className="w-full">
                <p className="text-sm text-body-color dark:text-dark-6">
                  ...
                  aliquet libero. Nunc a augue fermentum, pharetra ligula sed, aliquam lacus. Etiam congue ex enim
                </p>
              </div>
            </div>
          </div>
