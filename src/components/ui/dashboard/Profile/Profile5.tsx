      ...
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[970px]">
          ...
          <div className="mt-3 text-center">
            <h3 className="text-xl font-semibold text-dark dark:text-white sm:text-2xl">Danish Heilium</h3>
            <p className="mb-[18px] text-base font-medium text-body-color dark:text-dark-6">Ui/Ux Designer</p>
            <div className="-mx-[18px] mb-5 inline-flex rounded-sm bg-white py-[10px] shadow-profile-5 dark:bg-dark-2">
              <div className="border-r border-stroke px-[18px] dark:text-dark-3">
                <p className="text-sm text-body-color dark:text-dark-6">
                  <span className="text-base font-semibold text-dark dark:text-white">259</span>
                  Posts
                </p>
              </div>
              <div className="border-r border-stroke px-[18px] dark:border-dark-3">
                <p className="text-sm text-body-color dark:text-dark-6">
                  <span className="text-base font-semibold text-dark dark:text-white">129K </span>
                  Followers
                </p>
              </div>
              <div className="px-[18px]">
                <p className="text-sm text-body-color dark:text-dark-6">
                  <span className="text-base font-semibold text-dark dark:text-white">120 </span>
                  Following
                </p>
              </div>
            </div>
            <h4 className="mb-[18px] text-base font-semibold text-dark dark:text-white">About Me</h4>
            ...
            <h5 className="mb-3 text-base font-medium text-dark dark:text-white">Follow me on</h5>
