      ...
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[400px] overflow-hidden rounded-lg bg-white p-4 pb-8 shadow-card dark:bg-dark-2">
          ...
          <div className="mt-3 text-center">
            <h3 className="text-xl font-semibold text-dark dark:text-white">Apurbo Akhond</h3>
            <p className="mb-5 text-sm text-body-color dark:text-dark-6">UI/UX Designer</p>
            <p className="mx-auto mb-6 max-w-[310px] text-sm text-body-color dark:text-dark-6">
              Lorem ipsum dolor sit amet, consectetur solium adipiscing elit Pellentesque.
            </p>
            ...
            <div className="-mx-4 flex items-center justify-center">
              <div className="border-r border-stroke px-4 dark:border-dark-3">
                <p className="text-sm text-body-color">
                  <span className="text-base font-semibold text-dark dark:text-white">78 </span>
                  Followers
                </p>
              </div>
              <div className="px-4">
                <p className="text-sm text-body-color dark:text-dark-6">
                  <span className="text-base font-semibold text-dark dark:text-white">12 </span>
                  Following
                </p>
              </div>
            </div>
