      ...
      <div className="mb-8 rounded-lg border border-stroke bg-white p-6 dark:border-dark-3 dark:bg-dark-2 lg:px-4 xl:px-6">
        ...
        <div className="flex items-end justify-between">
          <div>
            ...
            <span className="text-sm text-body-color dark:text-dark-6">{totalTitle}</span>
          </div>
          <div>
            <p className={`inline-flex items-center text-sm font-medium ${increment ? 'text-green' : 'text-red'}`}>
              {increment}
              {decrement}
              <span className="pl-1">
                {increment && (
