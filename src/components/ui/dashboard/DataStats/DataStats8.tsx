...
const DataStatsCard = ({ totalTitle, total, increment, decrement }) => {
  return (
    <div className="mb-7 w-full border-stroke px-[30px] last-of-type:border-none dark:border-dark-3 sm:w-1/2 sm:border-r lg:mb-0 lg:w-1/4">
      <p className="text-sm font-medium text-body-color dark:text-dark-6">{totalTitle}</p>
      <p className="mb-2 text-2xl font-semibold text-dark dark:text-white">{total}</p>
            ...
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <clipPath id="clip0_2965_1213">
                  <rect width="10.2857" height="10.2857" fill="white" transform="translate(0.857666 0.859375)"></rect>
                </clipPath>
              </defs>
            </svg>
          )}
