  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      <div className="relative mb-8 flex items-center rounded-[10px] bg-white px-6 py-10 shadow-1 dark:bg-dark-2 dark:shadow-box-dark sm:px-10 md:px-6 xl:px-10">
        ...
        <div>
          <p className="text-2xl font-bold text-dark dark:text-white xl:text-[28px] xl:leading-[35px]">{number}</p>
          <p className="mt-1 text-base text-body-color dark:text-dark-6">{name}</p>
        </div>
