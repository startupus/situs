  ...
  return (
    <div className="mx-auto w-full max-w-[770px]">
      <div className="justify-between sm:flex">
        <h3 className="mb-8 text-2xl font-medium text-black md:text-[28px]">{title}</h3>
        <div className="mb-8">
          <div className="flex items-center sm:justify-end">
            <label htmlFor="sorting" className="mr-4 text-base font-medium text-black">
              Filter by:
            </label>
  ...
  return (
    <tr>
      ...
      <td className="min-w-[130px] py-[18px]">
        {shipped && (
          <span className="rounded-full bg-[#D7F8E4] py-1 px-4 text-sm font-medium text-success">Shipped</span>
        )}
        {!shipped && (
          <span className="rounded-full bg-[#FCF3CB] py-1 px-4 text-sm font-medium text-[#9F531F]">Processing</span>
        )}
      </td>
