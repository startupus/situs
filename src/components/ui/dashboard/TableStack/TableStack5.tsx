    ...
    <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[100px]">
      <div className="container mx-auto">
        <TableStackWrapper title="Checkbox List">
          <StackItem id="1" nameBg="[#FFB52B]" shortName="MC" name="Musharof Chowdhury" position="Founder & CEO" />
          <StackItem id="2" nameBg="[#00BFD9]" shortName="NR" name="Naimur Rahman" position="Product Designer" />
          <StackItem id="3" nameBg="[#4926BD]" shortName="SH" name="Shafiq Hammad" position="Frontend Developer" />
          <StackItem id="4" nameBg="[#094285]" shortName="MH" name="Mahbub Hasan" position="Backend Developer" />
        </TableStackWrapper>
      </div>
    </section>
  );
...
const TableStackWrapper = ({ title, children }) => {
  return (
    <div className="mx-auto mb-8 w-full max-w-[770px] rounded-lg border border-stroke bg-white">
      <div className="w-full border-b border-stroke py-6 px-7">
...
const StackItem = ({ shortName, name, position, id, nameBg }) => {
  return (
    <div className="flex items-center border-b border-stroke py-6 px-7 hover:bg-primary/5">
      <Checkbox id={id} />
      <div className="flex w-full items-center">
        ...
        <div className="w-full sm:flex">
          <h4 className="text-base font-medium text-black sm:min-w-[220px]">{name}</h4>
