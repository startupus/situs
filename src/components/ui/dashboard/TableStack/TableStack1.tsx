    ...
    <div className="flex items-center justify-between py-[18px] pl-6 pr-4 hover:bg-[#F5F5F5]">
      <div className="flex items-center">
        <div className="mr-[18px] h-[50px] w-full max-w-[50px] overflow-hidden rounded-full">
          <img src={img} alt="user" className="rounded-full object-cover object-center" />
        </div>
        <div>
...
const Dropdown = () => {
  ...
  return (
    <div className="relative">
      <button className="text-body-color" ref={trigger} onClick={() => setDropdownOpen(!dropdownOpen)}>
