...
const TableGrid1: React.FC<TableGrid1Props> = ({ className = '' }) => {
  return (
    <section className={`bg-white pb-[84px] pt-[120px] dark:bg-dark ${className}`}>
...
const TableGridItem: React.FC<TableGridItemProps> = ({ image, link, title, size }) => {
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/3 xl:w-1/4">
      <div className="mb-9">
        <div className="mb-[10px] overflow-hidden rounded-sm">
          <img
            src={image}
            alt="table grids"
