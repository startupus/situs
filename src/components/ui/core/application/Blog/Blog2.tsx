...
const Blog2: React.FC<Blog2Props> = ({ className = '' }) => {
  return (
    <>
      <section className={`bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px] ${className}`}>
...
const BlogCard: React.FC<BlogCardProps> = ({ image, CardSubTitle, CardTitle, CardDescription }) => {
  return (
    <>
...
const BlogSideCardItem: React.FC<BlogSideCardItemProps> = ({ subtitle, title, description }) => {
  return (
