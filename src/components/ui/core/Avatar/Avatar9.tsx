      ...
      <section className="bg-white dark:bg-dark py-[75px]">
        <div className="mx-auto px-4 sm:container">
          <div className="-mx-4 flex flex-wrap justify-center">
            ...
            <AvatarItem arrow img="https://cdn.tailgrids.com/2.0/image/dashboard/images/avatar/image-05.jpg">
              <DropdownItem link="/#">Profile</DropdownItem>
              <DropdownItem link="/#">Settings</DropdownItem>
              <DropdownItem link="/#">Sign Out</DropdownItem>
            </AvatarItem>
  ...
  return (
    <div className="mb-8 w-full px-4 md:w-1/2 lg:w-1/3">
      <div className="relative inline-block">
        <button className="flex items-center text-left" ref={trigger} onClick={() => setDropdownOpen(!dropdownOpen)}>
          ...
          {name && <span className="text-base font-medium text-dark dark:text-white">{name}</span>}
          {arrow && (
