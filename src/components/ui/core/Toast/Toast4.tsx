      ...
      <div className="mx-auto px-4 sm:container">
        <div className="relative flex max-w-[560px] rounded-lg border border-stroke bg-white p-[25px]">
          ...
          <div className="w-full pr-4 sm:pr-10">
            <h6 className="mb-2 text-base font-semibold text-black sm:text-lg">New update! available</h6>
            <p className="mb-6 text-sm font-medium text-body-color">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam nec ligula at dolor aliquam mollis.
            </p>
            <button className="text-base font-medium text-primary hover:underline">Update Now</button>
