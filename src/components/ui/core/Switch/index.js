...
const Switch = ({
  ...
  return (
    <>
      ...
      {toggleSecondary && (
        <div className="w-fit">
          <label htmlFor="toogleTwo" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleThree && (
        <div className="w-fit">
          <label htmlFor="toggleThree" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleFour && (
        <div className="w-fit">
          <label htmlFor="toggleFour" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleFive && (
        <div className="w-fit">
          <label htmlFor="toggleFive" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleSix && (
        <div className="w-fit">
          <label htmlFor="toggleSix" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleSeven && (
        <div className="w-fit">
          <label htmlFor="toggleSeven" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleEight && (
        <div className="w-fit">
          <label htmlFor="toggleEight" className="flex items-center cursor-pointer select-none">
            <div className="relative">
      ...
      {toggleNine && (
        <div className="w-fit">
          <label htmlFor="toggleNine" className="flex items-center cursor-pointer select-none">
            <div className="relative">
