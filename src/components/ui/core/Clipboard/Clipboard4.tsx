      ...
      <div className="container">
        <div className="mx-auto w-full max-w-[500px]">
          <div className="relative">
            ...
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus eius atque sint totam minus voluptatum
              quibusdam pariatur ut perferendis commodi eos vero ipsum, nostrum doloribus quae. Dolores incidunt earum
              ad.
            </textarea>
