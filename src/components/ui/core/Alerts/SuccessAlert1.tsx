      ...
      <div className="container">
        <div className="border-green shadow-1 dark:bg-dark-2 flex w-full rounded-lg border-l-[6px] bg-white px-7 py-8 md:p-9">
          ...
          <div className="w-full">
            <h5 className="mb-3 text-lg font-semibold text-dark dark:text-white">Message Sent Successfully</h5>
            <p className="mb-6 text-base leading-relaxed text-body-color dark:text-dark-6">
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
              industry's standard dummy text ever since the 1500s, when
            </p>
            <div className="flex">
              <a href="/#" className="inline-block mr-6 text-sm font-medium text-green hover:text-green-dark">
                View Status
              </a>
              <button className="text-sm font-medium text-dark hover:text-body-color dark:text-dark-6">Dismiss</button>
            </div>
          </div>
        </div>
      </div>
