                    ...
                    <li className="relative">
                      ...
                      >
                        <div className="grid gap-5 lg:grid-cols-3">
                          <div>
                            <h4 className="mb-3 text-sm font-semibold text-dark dark:text-white">New Arrivals</h4>
                          ...
                          <div>
                            <h4 className="mb-3 text-sm font-semibold text-dark dark:text-white">Trending</h4>
                            <div className="flex flex-col space-y-3">
                              <a
                                href="#"
                                className="text-base font-medium text-body-color hover:text-primary dark:text-dark-6"
                          ...
                          <div className="h-full w-full">
                            <a href="#" className="relative block h-full w-full overflow-hidden rounded-lg">
                              <div className="absolute inset-0 flex h-full w-full items-center justify-center bg-primary/60">
                                <div className="text-center">
                                  <span className="mb-1 block text-4xl font-bold text-white"> 50% </span>
                                  <span className="mb-4 block text-lg font-medium text-white">Flat Discount</span>
