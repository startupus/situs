    ...
    <div className="w-full px-4 sm:w-1/2 lg:w-1/3">
      <div className="mb-8 rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800 dark:shadow-gray-900/20">
        <div className="mb-5 flex items-center">
          <div
            className="relative mr-4 flex h-12 w-12 items-center justify-center rounded-lg"
            style={{ color: color }}
          >
            {icon}
            <div
              className="absolute inset-0 h-full w-full rounded-lg opacity-10"
        ...
        <div>
          <div className="mb-4 flex items-end">
            <p className="mr-2 text-2xl font-bold leading-none text-gray-900 dark:text-white">
              {value}
            </p>
            {trend && (
              <p
