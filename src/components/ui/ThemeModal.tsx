...
const ThemeModal: React.FC<ThemeModalProps> = ({
  ...
  return (
    <div className={`fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-dark/90 px-4 py-5 z-50 ${!centered ? 'items-start pt-20' : ''}`}>
      <div
        ref={modal}
        className={`w-full ${sizeClasses[size]} rounded-[20px] bg-white dark:bg-dark-2 ${className}`}
      >
        {/* Header */}
