...
export const ThemeTableHeader: React.FC<ThemeTableHeaderProps> = ({
  children,
  className = ''
}) => {
  return (
...
export const ThemeTableBody: React.FC<ThemeTableBodyProps> = ({
  children,
  className = ''
}) => {
  return (
...
export const ThemeTableRow: React.FC<ThemeTableRowProps> = ({
  children,
  className = '',
  onClick
}) => {
...
export const ThemeTableCell: React.FC<ThemeTableCellProps> = ({
  children,
  className = '',
  header = false
}) => {
  ...
  return (
    <Tag className={`${baseClasses} ${header ? headerClasses : cellClasses} ${className}`}>
      {children}
    </Tag>
  );
};
