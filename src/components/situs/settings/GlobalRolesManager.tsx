...
import { FiPlus, FiEdit2, FiTrash2, FiX, FiShield, FiUsers, FiSettings } from 'react-icons/fi';
...
const GlobalRolesManager: React.FC = () => {
    ...
    try {
      ...
      const mockPermissions: GlobalPermission[] = [
        ...
        },
        {
          ...
          description: 'Отправка приглашений новым пользователям',
          category: 'users',
          subcategory: 'Управление',
          isSystem: true,
        },
        ...
        // Права проектов
        {
          ...
          description: 'Создание новых проектов без ограничений',
          category: 'projects',
          subcategory: 'Создание',
          isSystem: true,
        },
        {
          id: 'projects.create.limited',
          name: 'projects.create.limited',
          displayName: 'Ограниченное создание проектов',
          description: 'Создание проектов с лимитами',
          category: 'projects',
          subcategory: 'Создание',
          isSystem: true,
        },
        {
          ...
          displayName: 'Управление всеми проектами',
          description: 'Редактирование и удаление любых проектов',
          category: 'projects',
          subcategory: 'Управление',
          isSystem: true,
        },
        {
          id: 'projects.manage.own',
          name: 'projects.manage.own',
          displayName: 'Управление собственными проектами',
          description: 'Редактирование только своих проектов',
          category: 'projects',
          subcategory: 'Управление',
          isSystem: true,
        },
        ...
        // Права контента
        {
          id: 'content.manage',
          name: 'content.manage',
          displayName: 'Управление всем контентом',
          description: 'Редактирование любого контента',
          category: 'content',
          subcategory: 'Управление',
          isSystem: true,
        },
        {
          ...
          displayName: 'Редактирование собственного контента',
          description: 'Редактирование только своего контента',
          category: 'content',
          subcategory: 'Редактирование',
          isSystem: true,
        },
  ...
  const updateRolePermissions = useCallback(
    async (roleId: string, newPermissions: string[]) => {
      setRoles((prev) =>
        prev.map((role) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {connectionStatus === 'connected' && (
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-gray-600 dark:text-gray-400">Автосохранение активно</span>
          </div>
        )}
      </div>
      ...
      <div className="flex justify-end">
        <ProButton variant="primary" onClick={() => setShowCreateForm(true)}>
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Уровень: {role.level}</p>
                {role.isSystem && (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Создание новой роли</h3>
              <button
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Название роли</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {newRoleForm.isEditingId
                    ? 'Редактируйте ID вручную'
                    : 'ID генерируется автоматически на основе названия'}
                </p>
              </div>
            ...
            <div className="flex justify-end space-x-4 mt-6">
              <ProButton variant="outline" onClick={() => setShowCreateForm(false)}>
                Отмена
              </ProButton>
              <ProButton
                variant="primary"
