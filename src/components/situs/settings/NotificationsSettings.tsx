...
const NotificationsSettings: React.FC<NotificationsSettingsProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-lg dark:bg-dark-2">
      <h3 className="text-xl font-semibold text-dark dark:text-white mb-6">Уведомления</h3>
      ...
      <div className="space-y-6">
        {Object.entries(globalSettings.notifications).map(([key, value]) => (
          <div key={key} className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-body-color dark:text-dark-6">Настройки уведомлений для {key}</p>
            </div>
        ...
        <div className="border-t border-stroke dark:border-gray-700 pt-6">
          <h4 className="font-medium text-dark dark:text-white mb-4">Дополнительные настройки</h4>

          <div className="space-y-4">
            {/* Звуковые уведомления */}
            <div className="flex items-center justify-between">
              <div>
                <h5 className="font-medium text-dark dark:text-white">Звуковые уведомления</h5>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h5 className="font-medium text-dark dark:text-white">Браузерные уведомления</h5>
                <p className="text-sm text-body-color dark:text-dark-6">Показывать уведомления в браузере</p>
              </div>
              <label className="relative inline-flex cursor-pointer items-center">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h5 className="font-medium text-dark dark:text-white">Email уведомления</h5>
                <p className="text-sm text-body-color dark:text-dark-6">Отправлять уведомления на email</p>
              </div>
              <label className="relative inline-flex cursor-pointer items-center">
                <input type="checkbox" defaultChecked={true} className="peer sr-only" />
                <div className="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-primary peer-checked:after:translate-x-full peer-checked:after:border-white dark:border-gray-600 dark:bg-gray-700"></div>
