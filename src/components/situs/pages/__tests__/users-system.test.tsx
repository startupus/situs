    ...
    isOpen ? (
      <div data-testid="user-modal">
        ...
        <form>
          ...
          <input id="email" type="email" defaultValue={user?.email || ''} placeholder="Введите email" />
          <label htmlFor="firstName">Имя</label>
          <input id="firstName" type="text" defaultValue={user?.firstName || ''} placeholder="Введите имя" />
          <label htmlFor="lastName">Фамилия</label>
          <input id="lastName" type="text" defaultValue={user?.lastName || ''} placeholder="Введите фамилию" />
          <label htmlFor="company">Компания</label>
          <input id="company" type="text" defaultValue={user?.company || ''} placeholder="Введите название компании" />
        ...
        <button
          onClick={() =>
            onSave({ email: 'test@test.com', firstName: 'Test', lastName: 'User', role: 'client', status: 'active' })
          }
        >
          Сохранить
        </button>
