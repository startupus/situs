...
const SitusWebsites: React.FC = () => {
  ...
  const filteredWebsites = websites.filter((w) => w.name.toLowerCase().includes(searchTerm.toLowerCase()));
      ...
      <div className="flex-1 p-6">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-body-color dark:text-dark-6 mt-2">Управление веб-сайтами и лендингами</p>
            </div>
            <Link
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-dark dark:text-white text-sm">{website.name}</h3>
                    <p className="text-xs text-body-color dark:text-dark-6">{website.template}</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="text-center">
                  <div className="text-lg font-semibold text-dark dark:text-white">{website.pages}</div>
        ...
        {filteredWebsites.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-dark dark:text-white mb-2">Сайты не найдены</h3>
            <p className="text-body-color dark:text-dark-6 mb-4">
              {searchTerm ? 'Попробуйте изменить поисковый запрос' : 'Создайте свой первый сайт'}
            </p>
            {!searchTerm && (
              <Link
                to="/projects/new?type=website"
