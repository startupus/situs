...
const SitusStores: React.FC = () => {
  ...
  return (
    <div className="flex">
      ...
      {/* Правая панель с магазинами */}
      <div className="flex-1 p-6">
        {/* Заголовок */}
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold text-dark dark:text-white">Магазины</h1>
              <p className="text-body-color dark:text-dark-6 mt-2">Управление интернет-магазинами</p>
            </div>
            <Link
              to="/projects/new?type=store"
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="flex-shrink-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" className="fill-current text-green-500">
                      <path d="M2 2V4H3V13C3 13.5523 3.44772 14 4 14H20C20.5523 14 21 13.5523 21 13V4H22V2H2ZM4 4H20V13H4V4Z" />
                      <path d="M6 6V8H7V6H6ZM9 6V8H10V6H9ZM12 6V8H13V6H12ZM15 6V8H16V6H15Z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold text-dark dark:text-white text-sm">{store.name}</h3>
                    <p className="text-xs text-body-color dark:text-dark-6">Интернет-магазин</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-body-color dark:text-dark-6">Посетители</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-semibold text-dark dark:text-white">{store.products}</div>
                  <div className="text-xs text-body-color dark:text-dark-6">Товары</div>
                </div>
                <div className="text-center">
                  <div className="text-lg font-semibold text-dark dark:text-white">{store.categories}</div>
                  <div className="text-xs text-body-color dark:text-dark-6">Категории</div>
                </div>
              </div>
        ...
        {filteredStores.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-dark dark:text-white mb-2">Магазины не найдены</h3>
            <p className="text-body-color dark:text-dark-6 mb-4">
              {searchTerm ? 'Попробуйте изменить поисковый запрос' : 'Создайте свой первый магазин'}
            </p>
            {!searchTerm && (
              <Link
                to="/projects/new?type=store"
