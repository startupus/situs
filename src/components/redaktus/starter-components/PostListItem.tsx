...
const PostListItem: React.FC<PostListItemProps> = ({ title, href, content, author, date, featuredImg }) => {
    ...
    <div className="flex flex-col hover:-translate-y-2 transition-transform duration-300">
      ...
      <div className="flex flex-col h-full">
        <div className="my-6">
          ...
          <p
            className={`mt-2 leading-6 transition-colors duration-200 ${
        ...
        <div className="flex items-center space-x-4">
          <img src={author.avatarUrl} alt={author.firstName + ' ' + author.lastName} className="w-8 rounded-full" />
          <div>
            <div
