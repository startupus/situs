...
const Navbar = () => {
  return (    <header className="absolute left-0 top-0 z-20 flex w-full items-center">
            ...
            <div>
              <nav className="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white px-6 py-5 shadow dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none lg:dark:bg-transparent">
                <ul className="block lg:flex">
                  <li><a href="/#" className="flex py-2 text-base font-medium text-dark hover:text-primary dark:text-white lg:ml-10 lg:inline-flex">Home</a></li>
                  <li><a href="/#" className="flex py-2 text-base font-medium text-dark hover:text-primary dark:text-white lg:ml-10 lg:inline-flex">Payment</a></li>
                  <li><a href="/#" className="flex py-2 text-base font-medium text-dark hover:text-primary dark:text-white lg:ml-10 lg:inline-flex">About</a></li>
                  <li><a href="/#" className="flex py-2 text-base font-medium text-dark hover:text-primary dark:text-white lg:ml-10 lg:inline-flex">Blog</a></li>
                </ul>
              </nav>
            </div>
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <a href="/#" className="px-7 py-3 text-base font-medium text-dark hover:text-primary dark:text-white">Sign in</a>
              <a href="/#" className="rounded-lg bg-primary px-7 py-3 text-base font-medium text-white hover:bg-primary/90">Sign Up</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-white pb-[110px] pt-[120px] dark:bg-dark lg:pt-[150px]">
            ...
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                ...
                <ul className="flex flex-wrap items-center">
                  <li>
                    <a href={primaryButtonUrl} className="inline-flex items-center justify-center rounded-md bg-primary px-6 py-3 text-center text-base font-medium text-white hover:bg-blue-dark lg:px-7">
                      <Text
                  ...
                  <li>
                    <a href={secondaryButtonUrl} className="inline-flex items-center justify-center px-5 py-3 text-center text-base font-medium text-[#464646] hover:text-primary dark:text-white">
                      <span className="mr-2">
                ...
                <div className="clients pt-16">
                  ...
                  <div className="flex items-center space-x-4">
                    <SingleImage href="#" imgSrc="/images/brands/ayroui.svg" />
                    <SingleImage href="#" imgSrc="/images/brands/graygrids.svg" />
                    <SingleImage href="#" imgSrc="/images/brands/uideck.svg" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="lg:ml-auto lg:text-right">
                <div className="relative z-10 inline-block pt-11 lg:pt-0">
                  <img
                    ...
                    alt="hero"
                    className="max-w-full lg:ml-auto rounded-lg shadow-lg"
                  />
        ...
        <div className="absolute right-0 top-0 z-[-1] opacity-30 lg:opacity-100">
          <svg width="450" height="556" viewBox="0 0 450 556" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="paint0_linear_25:217" x1="298.5" y1="-48" x2="66.5" y2="352" gradientUnits="userSpaceOnUse">
        ...
        <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
          <svg width="364" height="201" viewBox="0 0 364 201" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="paint0_linear_25:218" x1="6.5" y1="72.5" x2="66.5" y2="196" gradientUnits="userSpaceOnUse">
                <stop stopColor="#3056D3" stopOpacity="0.28" />
                <stop offset="1" stopColor="#C4C4C4" stopOpacity="0" />
              </linearGradient>
            </defs>
