...
export const ServicesBlock: React.FC<ServicesBlockProps> = ({
  ...
  // Массив иконок из оригинального кода
  const icons = [
    // Refreshing Design
    <svg key="icon1" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
    ...
    <svg key="icon2" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
    ...
    // 100+ Components
    <svg key="icon3" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
    ...
    // Speed Optimized
    <svg key="icon4" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
    ...
    // Fully Customizable
    <svg key="icon5" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
    ...
    // Regular Updates
    <svg key="icon6" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
            ...
            <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
              ...
              <Text
                ...
                renderBlock={({ children, onDoubleClick, className }) => (
                  <p
                    onDoubleClick={onDoubleClick}
                    className={`text-base text-body-color dark:text-dark-6 ${className}`}
                  >
                    {children}
                  </p>
                )}
            ...
            <div key={index} className="w-full px-4 md:w-1/2 lg:w-1/3">
              <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2 hover:shadow-lg dark:bg-dark-2 md:px-7 xl:px-10">
                ...
                <Text
                  ...
                  renderBlock={({ children, onDoubleClick, className }) => (
                    <p onDoubleClick={onDoubleClick} className={`text-body-color dark:text-dark-6 ${className}`}>
                      {children}
                    </p>
                  )}
                />
