...
declare namespace types {
  ...
  type LocalLinkPropsReal = React__default.PropsWithChildren<
    Omit<React__default.AnchorHTMLAttributes<HTMLAnchorElement>, keyof LocalLinkProps> & LocalLinkProps
  >;
  export type RenderLocalLink = ({
    href,
    target,
    className,
    activeClassName,
    ...
    tabIndex,
    children,
  }: LocalLinkPropsReal) => React__default.ReactElement;
  /**-
  ...
  export interface IReactBricksContext {
    ...
    allowAccentsInSlugs: boolean;
    warningIfLowBattery: boolean;
    isRtlLanguage: ({ language }: { language: string }) => boolean;
    rtlLanguages: string[];
  }
  /**
...
interface BaseRichTextProps {
  ...
  placeholder?: string;
  renderPlaceholder?: (props: { children: any }) => React__default.ReactElement;
  multiline?: boolean;
...
interface RichTextProps {
  ...
  placeholder?: string;
  renderPlaceholder?: (props: { children: any }) => React.ReactElement;
...
declare const ReactBricks: React.FC<
  types.ReactBricksConfig & {
    children: React.ReactNode;
  }
>;
...
declare function fetchPages<T extends boolean>(
  apiKey: string,
  {
    type,
    types,
...
export {
  ...
  ReactBricks,
  Repeater,
  CompatibleRichText as RichText,
  RichText as RichTextExt,
  Slot,
  SsoLogin,
  SsoLoginFailure,
  SsoLoginSuccess,
  ...
  useAdminContext,
  useAuth,
  usePage$1 as usePage,
  usePage as usePagePublic,
  usePageValues,
  usePages,
  usePagesPublic,
