    ...
    <Section bg={bg}>
      <Container size="lg" className="py-12 xl:py-20">
        <div className="max-w-xl mx-auto px-5">
          <Repeater propName="badge" renderWrapper={(items: any) => <div className="mb-4">{items}</div>} />
          ...
          >
            <RichText
              renderBlock={(props: any) => (
                <h1
                  className={classNames('text-center font-black mb-4 pb-1 bg-clip-text bg-gradient-to-r', titleColor)}
          ...
          <RichText
            renderBlock={(props: any) => (
              <p
                className={classNames('text-lg sm:text-xl text-center leading-7 sm:leading-8', textColor)}
                {...props.attributes}
              >
                {props.children}
              </p>
          ...
          <Repeater
            ...
            renderWrapper={(items: any) => (
              <div className="flex justify-center items-center flex-col sm:flex-row mt-6">{items}</div>
            )}
          />
        </div>
      </Container>
