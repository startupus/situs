...
const Container: React.FC<ContainerProps> = ({ size = 'lg', className, children }) => {
  return (
    <div className={classNames('mx-auto', { 'px-5': size !== 'full' }, getWidthClass(size), className)}>{children}</div>
  );
};
