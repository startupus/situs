...
const Badge: types.Brick<BadgeProps> = ({ color = badgeColors.gray.value, className }) => {
  return (
    <div className="flex justify-center items-center">
      <Text
        renderBlock={(props: any) => (
          <span
            className={classNames('text-sm font-black uppercase text-center', color.className, className)}
