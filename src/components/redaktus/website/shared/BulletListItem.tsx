...
const BulletListItem: types.Brick<BulletListItemProps> = ({ color = bulletColors.pinkLight.value, className }) => {
  return (
    <div className={classNames('flex justify-start items-center py-2 leading-tight', className)}>
      <div
        className={classNames('flex justify-center items-center w-5 h-5 rounded-full mr-4 text-sm', color.className)}
