...
const ReviewItem = ({ img, name, date, rating, title, details, replyItem }) => {
  return (
    <div className={`${replyItem && 'pt-11'}`}>
      <div className="items-center justify-between md:flex">
        <div className="mb-4 flex items-center">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-6">
            <h3 className="text-lg font-medium text-dark dark:text-white">{name}</h3>
            <p className="text-base font-medium text-body-color dark:text-dark-6">{date}</p>
          </div>
        </div>
        {rating && (
          <div className="mb-4 flex items-center">
      ...
      <div>
        <h4 className="mb-5 text-lg font-semibold text-dark dark:text-white sm:text-xl">{title}</h4>
        <p className={`mb-6 text-base font-medium text-body-color`}>{details}</p>
