          ...
          <div className="w-full px-4 lg:w-5/12">
            <div className="mb-10 overflow-hidden rounded-lg bg-white px-8 py-10 text-center shadow-three dark:bg-dark-2 dark:shadow-box-dark lg:mb-0 xl:px-[60px]">
              ...
              <div className="inline-flex flex-wrap items-center justify-center gap-4 rounded-md border-[.5px] border-stroke bg-gray-1 px-6 py-[10px] dark:border-dark-3 dark:bg-dark">
                ...
                <span className="text-base font-medium text-dark dark:text-white">4.7 out of 5</span>
              </div>

              <p className="pb-10 pt-3 text-base font-medium text-body-color dark:text-dark-6">40 customer ratings</p>

              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">5 star</span>
                  ...
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">84%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">4 star</span>
                  <div className="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                    <div className="absolute left-0 top-0 h-full w-[50%] rounded-full bg-[#FFA645]"></div>
                  </div>
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">9%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">3 star</span>
                  <div className="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                    <div className="absolute left-0 top-0 h-full w-[40%] rounded-full bg-[#FFA645]"></div>
                  </div>
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">4%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">2 star</span>
                  <div className="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                    <div className="absolute left-0 top-0 h-full w-[20%] rounded-full bg-[#FFA645]"></div>
                  </div>
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">2%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">1 star</span>
                  <div className="relative mx-3 h-[14px] w-full rounded-full bg-gray-2 dark:bg-dark">
                    <div className="absolute left-0 top-0 h-full w-[10%] rounded-full bg-[#FFA645]"></div>
                  </div>
                  <span className="whitespace-nowrap text-base font-medium text-dark dark:text-white">1%</span>
                </div>
              </div>
            </div>
          </div>
          <div className="w-full px-4 lg:w-7/12">
            ...
            <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
              <div className="px-6 py-8 sm:py-9 md:px-8 xl:px-9">
                ...
                <p className="mb-[10px] text-base font-medium text-dark dark:text-white">Click on star to review</p>
                ...
                <form>
                  <div className="-mx-3 flex flex-wrap">
                    ...
                    <div className="w-full px-3">
                      <InputGroup type="text" placeholder="Type review headline" />
                    </div>
...
const ReviewItem = ({ title, details, img, name, date, rating, like, replyButton }) => {
  return (
    <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
      <div className="px-6 py-8 sm:py-10 md:px-8 xl:px-10">
        <h4 className="mb-[18px] text-lg font-semibold text-dark dark:text-white sm:text-xl">{title}</h4>
      ...
      <div className="items-center justify-between border-t border-stroke px-6 pt-5 dark:border-dark-3 md:flex md:px-8 xl:px-9">
        <div className="mb-4 flex items-center">
          ...
          <div className="flex items-center">
            <h3 className="pr-6 text-base font-medium text-dark dark:text-white">{name}</h3>
