        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-6/12 xl:w-3/12">
              <div className="mb-16">
                <h3 className="mb-10 text-2xl font-semibold text-dark dark:text-white">Download App</h3>
                <div className="sm:flex md:block lg:flex xl:block">
                  ...
                  >
                    ...
                    <span className="text-white">
                      ...
                      <span className="block text-base font-semibold"> Apple App Store </span>
                    </span>
                  </a>
                  <a
                    href="/#"
                  ...
                  >
                    ...
                    <span className="text-white">
                      ...
                      <span className="block text-base font-semibold">Google Play Store</span>
                    </span>
                  </a>
                </div>
              </div>
  ...
  return (
    <div className="w-full border-stroke px-4 dark:border-dark-3 md:w-1/3 md:even:border-x">
      <div className="mb-[60px] text-center md:mt-[60px]">
        ...
        <div>
          <h3 className="mb-[10px] text-xl font-semibold text-dark dark:text-white xl:text-2xl">{title}</h3>
          <p className="mx-auto max-w-[275px] text-base text-body-color dark:text-dark-6">{subtitle}</p>
        </div>
      </div>
    </div>
  );
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12 lg:nth-3:w-4/12 xl:nth-3:w-3/12">
      <div className="mb-16">
        <h3 className="mb-9 text-2xl font-semibold text-dark dark:text-white">{header}</h3>
