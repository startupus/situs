          ...
          <div className="w-full px-4 xl:w-8/12">
            <div>
              <div className="bg-white dark:bg-dark-2 mb-10 overflow-hidden rounded-[10px] border border-stroke dark:border-dark-3 shadow-testimonial-6 dark:shadow-box-dark p-10">
                <h4 className="mb-[5px] text-2xl font-semibold text-dark dark:text-white">Order #15478</h4>
                <p className="text-body-color dark:text-dark-6 mb-9">21st Mart 2021 at 10:34 PM</p>
          ...
          <div className="w-full px-4 xl:w-4/12">
            <div>
              <div className="bg-white dark:bg-dark-2 shadow-testimonial-6 dark:shadow-box-dark overflow-hidden rounded-[10px] border border-stroke dark:border-dark-3 p-10">
                <h3 className="mb-8 text-xl font-semibold text-dark dark:text-white xl:text-2xl">Customer</h3>
                <div className="mb-8 flex items-center">
                  ...
                  <div>
                    <h4 className="text-base font-semibold text-dark dark:text-white mb-1">Willium Deno</h4>
                    <p className="text-body-color dark:text-dark-6 text-base">10 Previous Orders</p>
                  </div>
                </div>
                <div className="space-y-8">
                  <div className="flex">
                    ...
                    <div>
                      <h5 className="mb-[5px] text-lg font-semibold text-dark dark:text-white">Shipping Address</h5>
                      <p className="text-body-color dark:text-dark-6 text-base">New York, USA 2707 Davis Avenue</p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="mr-3 mt-1">
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <h5 className="mb-[5px] text-lg font-semibold text-dark dark:text-white">Email Address</h5>
                      <p className="text-body-color dark:text-dark-6 text-base">contact@yourmail.com</p>
                    </div>
                  </div>
    ...
    <tr>
      <td className="border-stroke dark:border-dark-3 border-t py-6 pr-4 pl-5 sm:pl-6">
        <div className="flex items-center">
          <img src={img} alt="product" className="mr-5 h-[60px] w-[60px] rounded-sm" />
          <div>
            <a
              href={link}
