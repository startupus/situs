  ...
  return (
    <div className="w-full px-4 md:w-1/2">
      <div className="relative overflow-hidden rounded-xl bg-gray-2 px-6 py-11 dark:bg-dark-2 sm:px-10 lg:py-[88px]">
        <img className="absolute bottom-0 right-0 w-full" src={img} alt="Banner" />
        <div className="z-1 relative w-2/3 lg:w-3/4 xl:w-1/2">
          <h4 className="mb-3 text-lg font-semibold text-dark dark:text-white">{title}</h4>
          <h2 className="text-xl font-bold text-dark dark:text-white lg:text-3xl">{subtitle}</h2>
          <a
            href={buttonLink}
