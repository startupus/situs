          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-5/12">
              <div className="hero-content">
                <span className="mb-4 block text-lg font-medium text-primary">Download our app</span>
                  ...
                  <li>
                    ...
                    >
                      <span className="mr-4 text-dark group-hover:text-primary dark:text-dark-2">
                        ...
                        >
                          <rect width="44.075" height="44.075" rx="10" fill="" />
                          <path
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="mx-auto text-center">
                <div className="relative z-10 mt-16 inline-block lg:mt-0">
                  <img
                    src="https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-06.svg"
                    alt="hero"
                    className="mx-auto max-w-full"
                  />
                  <div className="absolute -left-10 -top-10 z-[-1]">
                    <img src="https://cdn.tailgrids.com/1.0/assets/images/hero/hero6-shape-1.svg" alt="shape" />
                  </div>
...
const Navbar = () => {
  ...
  return (
    <header className={`absolute left-0 top-0 z-20 flex w-full items-center bg-transparent`}>
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            <div>
              ...
              <nav
                id="navbarCollapse"
                className={`absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white px-6 py-5 shadow dark:bg-dark lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none lg:dark:bg-transparent ${
                  !open && 'hidden'
                } `}
              >
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <a href="/#" className="px-5 py-2 text-base font-medium text-dark hover:text-primary dark:text-white">
                Sign in
              </a>
