              ...
              <div className="flex flex-wrap bg-primary">
                <button
                  ...
                  className={`flex items-center text-sm md:text-base font-medium text-white border-b-[3px] py-3 lg:py-4 px-6 lg:px-10 ${
                    open === 'home' ? 'border-[#1E41B6]' : 'border-primary hover:border-[#1E41B6]'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center text-sm md:text-base font-medium text-white border-b-[3px] py-3 lg:py-4 px-6 lg:px-10 ${
                    open === 'about' ? 'border-[#1E41B6]' : 'border-primary hover:border-[#1E41B6]'
                  }`}
                >
                  <span className="text-white mr-2">
                ...
                <button
                  ...
                  className={`flex items-center text-sm md:text-base font-medium text-white border-b-[3px] py-3 lg:py-4 px-6 lg:px-10 ${
                    open === 'team' ? 'border-[#1E41B6]' : 'border-primary hover:border-[#1E41B6]'
                  }`}
                >
                  <span className="text-white mr-2">
                ...
                <button
                  ...
                  className={`flex items-center text-sm md:text-base font-medium text-white border-b-[3px] py-3 lg:py-4 px-6 lg:px-10 ${
                    open === 'company' ? 'border-[#1E41B6]' : 'border-primary hover:border-[#1E41B6]'
                  }`}
                >
                  <span className="text-white mr-2">
