          ...
          <div className="relative z-10 flex min-h-[328px] items-center justify-center overflow-hidden rounded-2xl border border-dashed border-stroke bg-gray-1 p-6 dark:border-dark-3 dark:bg-white/5 md:p-10">
            <label for="">
              ...
              <div className="mx-auto w-full max-w-[290px] text-center">
                <h3 className="mb-3 text-xl font-bold text-dark dark:text-white">Drop File Here</h3>
                <p className="mb-5 text-base text-dark-4 dark:text-dark-6">
                  Drag and drop your PNG, JPG, WebP, SVG images here or browse
                </p>
                <button className="text-base font-medium text-primary underline underline-offset-2">Browse File</button>
              </div>
            </label>
