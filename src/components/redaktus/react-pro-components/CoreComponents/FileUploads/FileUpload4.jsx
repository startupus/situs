      ...
      <div className="container">
        <div className="relative mx-auto w-full max-w-[650px] rounded-xl bg-white shadow-lg dark:bg-dark-2">
          <div className="px-7 py-8">
            <div className="mb-6">
              <h3 className="text-xl font-semibold text-dark dark:text-white">Upload Files</h3>
                ...
                <div>
                  ...
                  <div>
                    <p className="mb-2 text-center text-base text-dark-4 dark:text-dark-6">
                      ...
                      <button className="font-medium text-primary">Browse</button>
                    </p>
                    <p className="text-center text-sm text-dark-4 dark:text-dark-6">Max 10 MB files are allowed</p>
                  </div>
                </div>
              </label>
            </div>
            <div>
              <h3 className="mb-4 text-lg font-semibold text-dark dark:text-white">Uploads:</h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between overflow-hidden rounded-lg border border-stroke p-3 pr-5 dark:border-dark-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base text-dark dark:text-white">randomfile.pdf</p>
                      <p className="text-base text-body-color dark:text-dark-6">20.5 KB</p>
                    </div>
                  </div>
                  <div>
                ...
                <div className="relative flex items-center justify-between overflow-hidden rounded-lg border border-stroke p-3 pr-5 dark:border-dark-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base text-dark dark:text-white">screenshort.jpg</p>
                      <p className="text-base text-body-color dark:text-dark-6">uploading...</p>
                    </div>
                  </div>
                  <div>
                    <button className="flex items-center justify-center gap-2 rounded-lg border border-stroke px-3 py-2 text-sm font-medium text-dark-4 duration-200 hover:bg-dark hover:text-white dark:border-dark-3 dark:text-dark-6">
                ...
                <div className="flex items-center justify-between overflow-hidden rounded-lg border border-stroke p-3 pr-5 dark:border-dark-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base text-dark dark:text-white">text-file.pdf</p>
                      <p className="text-base text-body-color dark:text-dark-6">14.5 KB</p>
                    </div>
                  </div>
                  <div>
                    <button className="flex items-center justify-center gap-2 rounded-lg border border-stroke px-3 py-2 text-sm font-medium text-dark-4 duration-200 hover:bg-dark hover:text-white dark:border-dark-3 dark:text-dark-6">
