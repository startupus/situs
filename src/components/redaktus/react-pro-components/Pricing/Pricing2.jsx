    ...
    <section className="relative z-20 overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center lg:flex-nowrap">
          <PricingCard type="STARTING FROM" price="€ 19.99" subscription="mo" buttonText="Purchase Now" first>
            <List>1 User</List>
          ...
          <PricingCard type="STARTING FROM" price="€ 19.99" subscription="mo" buttonText="Purchase Now" active>
          ...
          <PricingCard type="STARTING FROM" price="€ 70.99" subscription="mo" buttonText="Purchase Now" last>
...
const PricingCard = ({ children, price, type, subscription, buttonText, active, first, last }) => {
  return (
    <div className={`w-full ${active ? 'lg:max-w-[370px]' : 'lg:max-w-[406px]'}`}>
      <div
        className={` ${
          active
        ...
        } ${first && 'lg:rounded-r-none lg:border-r-0'} ${last && 'lg:rounded-l-none lg:border-l-0'} `}
      >
        {active && (
        ...
        <h2 className={`mb-9 text-[28px] font-semibold ${active ? `text-white` : `text-primary`}`}>
          {price} / {subscription}
        </h2>
        ...
        {first && <span className="absolute bottom-0 left-0 z-[-1] block h-14 w-14 rounded-tr-full bg-primary"></span>}
        {last && <span className="absolute right-0 top-0 z-[-1] block h-14 w-14 rounded-bl-full bg-secondary"></span>}
        {active && (
          <div>
