        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="w-full px-4 xl:w-10/12">
            <div className="mb-[60px] max-w-[510px]">
              <span className="mb-2 block text-lg font-semibold text-primary">Pricing Plan</span>
              <h2 className="mb-3 text-3xl font-bold text-white sm:text-4xl">Our Best Pricing</h2>
...
const PricingCard = ({ children, price, type, subscription, buttonText, buttonLink, active }) => {
  return (
    <div className="w-full px-4 xl:w-10/12">
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="mt-10 w-full lg:mt-0">
              <h3 className="mb-[22px] text-[35px] font-bold leading-none text-white">{price}</h3>
              <a
                href={buttonLink}
...
const List = ({ children, notChecked }) => {
  return (
    <p className={`mb-4 flex text-base ${notChecked ? 'text-body-color' : 'text-gray-7'}`}>
