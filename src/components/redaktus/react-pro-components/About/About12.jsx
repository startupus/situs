      ...
      <div className="container">
        <div className="mx-auto mb-16 w-full max-w-[970px] text-center">
          <p className="mb-9 text-xl text-body-color md:text-2xl dark:text-dark-6">
            ...
            <span className="font-semibold italic text-dark dark:text-white">adipiscing elit fusce</span>
            et varius ex. Morbi ac tellus tortor orci varius natoque penatibus et magnis dis parturient montes, nascetur
            ridiculus mus. Curabitur
            <span className="font-semibold text-dark dark:text-white">tincidunt consectetur</span>
            arcu eu fermentum. Cras rhoncus dapibus quam penatibus et magnis dis parturient.
          </p>
          <a
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-7/12">
            <div className="w-full overflow-hidden rounded-2xl max-lg:mb-8">
              <img
                src="https://i.ibb.co/s6Wnmvn/image-1.jpg"
                alt="about image"
            ...
            <div className="md:grid- grid gap-8">
              <div className="relative z-10 w-full overflow-hidden rounded-2xl bg-primary p-7">
                <p className="mb-14 text-base text-gray-3">
                  Lorem Ipsum is simply dummy text of the printing global tech dapibus quam penatibus et.
                </p>
                ...
                <div className="absolute right-0 top-0 -z-10">
                  <img src="./images/about/about-12/shape-1.svg" alt="shape-1" />
                </div>
              </div>
              <div className="relative z-10 w-full overflow-hidden rounded-2xl bg-dark p-7 dark:bg-dark-2">
                ...
                <div className="absolute right-0 top-0 -z-10">
                  <img src="./images/about/about-12/shape-2.svg" alt="shape-2" />
                </div>
              </div>
            </div>
          </div>
