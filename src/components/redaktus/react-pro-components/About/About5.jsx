            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="relative mx-auto flex h-[500px] max-w-[440px]">
                <div className="absolute left-0 z-30 mr-14 max-w-[270px] rounded-lg">
                  <img src="https://i.ibb.co/CvVpnCZ/image-01.jpg" alt="about image" className="w-full rounded-lg" />
                ...
                <div className="absolute right-0 top-20 z-30 ml-14 max-w-[300px] rounded-lg">
                  <img src="https://i.ibb.co/qpHSL3Z/image-02.jpg" alt="about image" className="w-full rounded-lg" />
                </div>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/2 2xl:w-5/12">
              <div className="sm:mt-10 lg:mt-0">
                <span className="block mb-2 text-lg font-semibold uppercase text-primary">WHAT WE ACHIEVED</span>
                ...
                <h3 className="mb-4 text-lg font-bold text-dark dark:text-white">Company Benefits</h3>
                <p className="text-base text-body-color dark:text-dark-6 mb-9">
                  ...
                  elit consequat ipsum, nec sagittis sem, tidiomic consequat ipsum.
                </p>
                <h3 className="mb-4 text-lg font-bold text-dark dark:text-white">Competitive Salary</h3>
                <p className="text-base text-body-color dark:text-dark-6">
                  Proin gravida nibh vel velit auctor aliquet. aks Aenean sollicitudin, lorem quis bibendum auctor.
                </p>
              </div>
            </div>
          </div>
