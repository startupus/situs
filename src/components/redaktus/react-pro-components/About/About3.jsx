          ...
          <div className="-mx-4 mb-10 flex flex-wrap items-center lg:mb-[60px]">
            <div className="w-full px-4 lg:w-6/12">
              <div className="mb-[60px] max-w-[500px] xl:mb-[70px]">
                <span className="block mb-2 text-lg font-semibold text-primary">About Our App</span>
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="flex justify-center">
                <img
                  src="https://cdn.tailgrids.com/2.0/image/marketing/images/about/about-03/image-01.svg"
                  alt="image"
