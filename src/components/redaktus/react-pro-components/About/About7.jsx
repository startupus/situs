          ...
          <div className="flex flex-wrap items-end justify-between -mx-4">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-10 lg:mb-0">
                <span className="block mb-2 text-lg font-semibold uppercase text-primary sm:text-xl">ABOUT ME</span>
                ...
                <p className="text-base text-body-color dark:text-dark-6 mb-9">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque dui ligula, malesuada vel convallis
                  in, tincidunt ut mi Vestibulum sit amet.
                </p>
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full px-4 md:w-1/2 lg:w-full xl:w-7/12">
                    <div className="inline-flex items-center p-5 mb-8 bg-white rounded-lg dark:bg-dark-2 shadow-[0px_1px_4px_0px_rgba(0,0,0,0.12)] xl:mb-0">
                      ...
                      <div className="w-full">
                        <span className="text-sm font-medium text-body-color dark:text-dark-6">Email address</span>
                  ...
                  <div className="w-full px-4 md:w-1/2 lg:w-full xl:w-5/12">
                    <div className="mb-8 xl:mb-0">
                      <h5 className="mb-3 text-base font-medium text-body-color dark:text-dark-6">Follow Me On:</h5>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="space-y-8">
                <div>
                  <h5 className="mb-5 text-lg font-semibold text-dark dark:text-white">Design</h5>
                ...
                <div>
                  <h5 className="mb-5 text-lg font-semibold text-dark dark:text-white">Branding</h5>
                  <div className="relative w-full h-2 rounded-2xl bg-stroke dark:bg-dark-3">
                    <div className="bg-primary absolute top-0 left-0 h-full w-[70%] rounded-2xl"></div>
                  </div>
                </div>
                <div>
                  <h5 className="mb-5 text-lg font-semibold text-dark dark:text-white">Web Design</h5>
                  <div className="relative w-full h-2 rounded-2xl bg-stroke dark:bg-dark-3">
