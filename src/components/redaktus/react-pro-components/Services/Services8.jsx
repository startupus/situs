        ...
        <div className="-mx-4 flex flex-wrap">
            ...
            <div className="mb-8">
              <div className="mb-5 rounded-[22px] bg-linear-to-t from-[#F7E8F3] to-[#DDDCF8] p-5">
                <div className="flex items-center justify-center rounded-[10px] bg-[linear-gradient(180deg,rgba(255,255,255,0.41)45.89%,rgba(255,255,255,0.00)100%)] pb-10 pt-5">
                  <img src="./images/services/services-08/image-1.svg" alt="image alt text" />
                </div>
              </div>
              <div className="text-center">
                <h3 className="mb-4 text-2xl font-bold text-dark dark:text-white">Resource Flexibility</h3>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mb-8">
              <div className="mb-5 rounded-[22px] bg-linear-to-t from-[#F7E8F3] to-[#DDDCF8] p-5">
                <div className="flex items-center justify-center rounded-[10px] bg-[linear-gradient(180deg,rgba(255,255,255,0.41)45.89%,rgba(255,255,255,0.00)100%)] pb-10 pt-5">
                  <img src="./images/services/services-08/image-2.svg" alt="image alt text" />
                </div>
              </div>
              <div className="text-center">
                <h3 className="mb-4 text-2xl font-bold text-dark dark:text-white">Easy to Use</h3>
                <p className="mb-6 text-body-color dark:text-dark-6">
                  This is an excellent option for people & small businesses who are starting out.
                </p>
                <a
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mb-8">
              <div className="mb-5 rounded-[22px] bg-linear-to-t from-[#F7E8F3] to-[#DDDCF8] p-5">
                <div className="flex items-center justify-center rounded-[10px] bg-[linear-gradient(180deg,rgba(255,255,255,0.41)45.89%,rgba(255,255,255,0.00)100%)] pb-10 pt-5">
                  <img src="./images/services/services-08/image-3.svg" alt="image alt text" />
                </div>
              </div>
              <div className="text-center">
                <h3 className="mb-4 text-2xl font-bold text-dark dark:text-white">Quick & Responsive</h3>
                <p className="mb-6 text-body-color dark:text-dark-6">
                  This is an excellent option for people & small businesses who are starting out.
                </p>
                <a
