        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              <span className="mb-2 block text-lg font-semibold text-white">Our Team Members</span>
        ...
        <div className="group mb-8 bg-white dark:bg-dark-2">
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 flex w-full items-center justify-center space-x-4 opacity-0 transition-all group-hover:bottom-6 group-hover:opacity-100">
              <a href={facebookLink} className="flex h-8 w-8 items-center justify-center rounded-full bg-[#4064AC]">
              ...
              <a href={twitterLink} className="flex h-8 w-8 items-center justify-center rounded-full bg-[#1C9CEA]">
              ...
              <a href={instagramLink} className="flex h-8 w-8 items-center justify-center rounded-full bg-[#D9377B]">
          ...
          <div className="px-4 py-6 text-center">
            <h3 className="mb-1 text-lg font-semibold text-dark dark:text-white">{name}</h3>
