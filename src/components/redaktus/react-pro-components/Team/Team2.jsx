      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
        <div className="mb-10">
          <div className="[h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
            <img src={imageSrc} alt="" className="w-full rounded-full" />
          ...
          <div className="text-center">
            <h4 className="mb-1 text-lg font-medium text-dark dark:text-white">{name}</h4>
            <p className="mb-5 text-xs font-medium text-body-color dark:text-dark-6">{profession}</p>
            <div className="flex items-center justify-center">
              <a
                href={facebookLink}
                className="mx-1 flex h-8 w-8 items-center justify-center text-body-color hover:text-primary"
              >
