/**
 * VerticalNavbar1 - VerticalNavbar компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: DashboardComponents
 * Подкатегория: VerticalNavbar
 * 
 * @component
 * @example
 * <VerticalNavbar1 
...
interface VerticalNavbar1Props {
  menu: string;
  link: string;
  submenu: string;
  children: string;
...
const VerticalNavbar = () => {
  return (
    <div className="redaktus-component" data-component-type="verticalnavbar1">
