/**
 * VerticalNavbar7 - VerticalNavbar компонент
 * 
...
interface VerticalNavbar7Props {
  title: string;
}

const VerticalNavbar7: React.FC<VerticalNavbar7Props> = () => {
  return (
...
const MenuTitle = ({ title }) => {
  return (
    <div className="redaktus-component" data-component-type="verticalnavbar7">
