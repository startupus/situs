/**
 * VerticalNavbar6 - VerticalNavbar компонент
 * 
...
interface VerticalNavbar6Props {
  href: string;
  icon: string;
}

const VerticalNavbar6: React.FC<VerticalNavbar6Props> = () => {
  return (
...
const IconLink = ({ href, icon }) => {
  return (
    <div className="redaktus-component" data-component-type="verticalnavbar6">
