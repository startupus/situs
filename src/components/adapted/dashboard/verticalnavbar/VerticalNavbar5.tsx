/**
 * VerticalNavbar5 - VerticalNavbar компонент
 * 
...
interface VerticalNavbar5Props {
  menu: string;
  link: string;
  submenu: string;
  message: string;
...
const VerticalNavbar5: React.FC<VerticalNavbar5Props> = () => {
  return (
...
export default VerticalNavbar5;
...
const NavItem = ({ menu, link, submenu, message, icon, children }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="verticalnavbar5">) => document.removeEventListener("click", clickHandler);
  });
