/**
 * VerticalNavbar4 - VerticalNavbar компонент
 * 
...
interface VerticalNavbar4Props {
  menu: string;
  link: string;
  submenu: string;
  message: string;
...
const VerticalNavbar4: React.FC<VerticalNavbar4Props> = () => {
  return (
...
const NavItem = ({ menu, link, submenu, message, icon, children }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="verticalnavbar4">) => document.removeEventListener("click", clickHandler);
  });
