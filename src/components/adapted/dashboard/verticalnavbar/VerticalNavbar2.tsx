/**
 * VerticalNavbar2 - VerticalNavbar компонент
 * 
...
interface VerticalNavbar2Props {
  menu: string;
  link: string;
  submenu: string;
  icon: string;
...
const VerticalNavbar2: React.FC<VerticalNavbar2Props> = () => {
  return (
...
const NavItem = ({ menu, link, submenu, icon, children }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="verticalnavbar2">) => document.removeEventListener("click", clickHandler);
  });
