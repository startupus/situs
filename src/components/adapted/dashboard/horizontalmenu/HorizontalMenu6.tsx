/**
 * HorizontalMenu6 - HorizontalMenu компонент
 * 
...
interface HorizontalMenu6Props {
  target: string;
}

const HorizontalMenu6: React.FC<HorizontalMenu6Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="horizontalmenu6">) => document.removeEventListener("click", clickHandler);
  });
      ...
      <div className="mx-auto w-full px-4 xl:container">
        <div className="flex items-center justify-between bg-primary px-4 xl:px-[30px]">
          <div className="mr-4 max-w-[100px] lg:mr-12">
            <a href={props.href || "/#"} className="block py-4">
              <img
            ...
            <div className="mr-4 flex items-center">
              ...
              <div className="relative mr-11 hidden w-full max-w-[250px] lg:block">
                <input
                  type="text"
                  placeholder="Search..."
                  className="h-9 w-full rounded-sm border border-transparent bg-white/[0.08] pl-10 pr-4 text-sm font-medium text-white/50 outline-hidden focus:border-white"
                />
            ...
            <div className="flex items-center justify-end">
              <div className="relative mr-7 hidden sm:block">
                <div className="h-4 w-6">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/assets/images/countries/usa.svg"}
                    alt={props.imageAlt || "country"}
              ...
              <div className="group relative">
                <div className="flex cursor-pointer items-center">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/assets/images/avatar/image-04.jpg"}
