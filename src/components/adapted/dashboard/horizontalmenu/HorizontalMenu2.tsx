/**
 * HorizontalMenu2 - HorizontalMenu компонент
 * 
...
interface HorizontalMenu2Props {
  link: string;
  name: string;
}

const HorizontalMenu2: React.FC<HorizontalMenu2Props> = () => {
  return (
        ...
        <div className="flex items-center justify-end bg-white px-3 py-3 dark:bg-dark-2 sm:justify-between md:px-7 md:py-7">
          ...
          <div className="flex items-center justify-end space-x-4">
            ...
            <div className="group relative">
              <button className="h-12 w-full max-w-[48px] cursor-pointer rounded-full">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/assets/images/avatar/image-01.jpg"}
...
const SubmenuItem = ({ link, name }) => {
  return (
    <div className="redaktus-component" data-component-type="horizontalmenu2">
    <a
      href={link}
