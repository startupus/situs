/**
 * HorizontalMenu4 - HorizontalMenu компонент
 * 
...
interface HorizontalMenu4Props {
  link: string;
  menu: string;
}

const HorizontalMenu4: React.FC<HorizontalMenu4Props> = () => {
  return (
...
const NavItem = ({ link, menu }) => {
  return (
    <div className="redaktus-component" data-component-type="horizontalmenu4">
    <li>
      <a
        href={link}
