/**
 * HorizontalMenu5 - HorizontalMenu компонент
 * 
...
interface HorizontalMenu5Props {
  link: string;
  menu: string;
}

const HorizontalMenu5: React.FC<HorizontalMenu5Props> = () => {
  return (
...
const NavItem = ({ link, menu }) => {
  return (
    <div className="redaktus-component" data-component-type="horizontalmenu5">
    <li>
      <a
        href={link}
