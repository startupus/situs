...
const Popover = () => {
  return (
    <div className="redaktus-component" data-component-type="popover1">
          ...
          <div className="group relative lg:inline-block">
            <div className="inline-flex items-center justify-center">
              <img
                ...
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/popover/popover-01/avatar-01.png"}
                alt={props.imageAlt || "avatar"}
              />
              <img
                className="-ml-6 h-[70px] w-[70px] rounded-full border-4 border-white dark:border-dark-3"
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/popover/popover-01/avatar-02.png"}
                alt={props.imageAlt || "avatar"}
              />
              <img
                className="-ml-6 h-[70px] w-[70px] rounded-full border-4 border-white dark:border-dark-3"
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/popover/popover-01/avatar-03.png"}
                alt={props.imageAlt || "avatar"}
              />
            </div>
                ...
                <div className="pt-[22px] pb-5 px-[22px]">
                  ...
                  <div>
                    <div className="mb-4 overflow-hidden rounded-sm">
                      <img
                        src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/popover/popover-01/image-01.jpg"}
