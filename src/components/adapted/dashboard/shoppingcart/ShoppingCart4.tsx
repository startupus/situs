/**
 * ShoppingCart4 - ShoppingCart компонент
 * 
...
const ShoppingCart4: React.FC<ShoppingCart4Props> = () => {
  return (
...
const CartItem = ({ img, link, title, size, color, price, stock }) => {
  return (
    <div className="redaktus-component" data-component-type="shoppingcart4">
