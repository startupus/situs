/**
 * ShoppingCart3 - ShoppingCart компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: DashboardComponents
 * Подкатегория: ShoppingCart
 * 
 * @component
 * @example
 * <ShoppingCart3 
...
const ShoppingCart3: React.FC<ShoppingCart3Props> = () => {
  return (
        ...
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-4/12">
            ...
            <div className="mb-8 overflow-hidden rounded-xl border border-[#e7e7e7] bg-white px-6 py-6 xs:px-8">
              ...
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/shopping-carts/shopping-cart-02/payment.svg"}
...
const TableRow = ({ img, link, title, subtitle, price }) => {
  return (
    <div className="redaktus-component" data-component-type="shoppingcart3">
    <tr>
