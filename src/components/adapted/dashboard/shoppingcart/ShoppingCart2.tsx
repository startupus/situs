/**
 * ShoppingCart2 - ShoppingCart компонент
 * 
...
const ShoppingCart2: React.FC<ShoppingCart2Props> = () => {
  return (
...
const CartItem = ({ img, link, title, subtitle, color, price }) => {
  return (
    <div className="redaktus-component" data-component-type="shoppingcart2">
