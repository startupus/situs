...
interface ChatList2Props {
  target: string;
}

const ChatList2: React.FC<ChatList2Props> = () => {
  return (
...
const Dropdown = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="chatlist2">) => document.removeEventListener("click", clickHandler);
  });
