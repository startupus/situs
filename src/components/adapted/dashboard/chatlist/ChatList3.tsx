...
const ChatList3: React.FC<ChatList3Props> = () => {
  return (
...
const ChatItem = ({ img, name, text, time, active, number }) => {
  return (
    <div className="redaktus-component" data-component-type="chatlist3">
