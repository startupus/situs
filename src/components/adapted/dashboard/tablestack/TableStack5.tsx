/**
 * TableStack5 - TableStack компонент
 * 
...
interface TableStack5Props {
  title: string;
  children: string;
}

const TableStack5: React.FC<TableStack5Props> = () => {
  return (
...
const TableStackWrapper = ({ title, children }) => {
  return (
    <div className="redaktus-component" data-component-type="tablestack5">
