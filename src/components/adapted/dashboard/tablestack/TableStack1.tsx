/**
 * TableStack1 - TableStack компонент
 * 
...
const TableStack = () => {
  return (
    <div className="redaktus-component" data-component-type="tablestack1">
...
const Dropdown = () => {
  ...
  return (
    <div className='relative'>
      ...
      >
        <button className='text-body-color hover:bg-gray-2 w-full rounded-sm py-1.5 px-3 text-left text-sm'>
          Edit
        </button>
        <button className='text-body-color hover:bg-gray-2 w-full rounded-sm py-1.5 px-3 text-left text-sm'>
          Delete
