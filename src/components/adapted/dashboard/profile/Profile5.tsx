...
const Profile5 = () => {
  return (
    <div className="redaktus-component" data-component-type="profile5">
    <section className="bg-gray-2 py-24 dark:bg-dark">
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[970px]">
          <div className="relative h-[130px] md:h-[260px]">
            <img
              src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-05/cover.jpg"}
          ...
          <div className="relative">
            <div className="relative z-10 mx-auto -mt-[60px] h-[120px] w-full max-w-[120px] rounded-full p-2 md:-mt-[86px] md:h-[176px] md:max-w-[176px]">
              ...
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-05/profile.png"}
                alt={props.imageAlt || "profile"}
