...
const Profile = () => {
  return (
    <div className="redaktus-component" data-component-type="profile1">
      ...
      <div className="mx-auto px-4 md:container">
        <div className="mx-auto w-full max-w-[970px] overflow-hidden rounded-sm bg-white shadow-card dark:bg-dark-2">
          <div className="relative z-20 h-[140px] sm:h-[160px] md:h-auto">
            <img
              src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-01/cover.jpg"}
              alt={props.imageAlt || "profile cover"}
              className="h-full w-full object-cover object-center"
            />
            <div className="absolute bottom-5 right-5 z-10">
              <label
                htmlFor="cover"
                className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-sm border border-white/35 bg-white/30 text-white hover:bg-white/20"
              >
                <input
                  type="file"
                  name="cover"
          ...
          <div className="flex flex-wrap px-5 pb-9 pt-6 sm:px-9 md:flex-nowrap">
            <div className="relative -top-14 z-30 h-[120px] w-full max-w-[120px] rounded-full border-4 border-white shadow-card dark:border-dark sm:h-[160px] sm:max-w-[160px]">
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-01/profile.png"}
                alt={props.imageAlt || "profile"}
                className="h-full w-full rounded-full object-cover object-center"
              />
              <label
                htmlFor="profile"
                className="absolute bottom-2 right-2 flex h-[34px] w-[34px] cursor-pointer items-center justify-center rounded-full bg-primary text-white hover:bg-primary/90"
              >
                <svg
                  width="14"
                  height="14"
            ...
            <div className="w-full md:pl-6">
              <div className="mb-6 items-center justify-between sm:flex">
                <div className="mb-8 sm:mb-0">
                  <h4 className="mb-1.5 text-2xl font-bold text-dark dark:text-white">
                    Danish Hebo
                  </h4>
              ...
              <div className="w-full">
                <p className="text-sm text-body-color dark:text-dark-6">
                  ...
                  fermentum, pharetra ligula sed, aliquam lacus. Etiam congue ex
                  enim
                </p>
              </div>
            </div>
