/**
 * Profile4 - Profile компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: DashboardComponents
 * Подкатегория: Profile
 * 
 * @component
 * @example
 * <Profile4 
...
const Profile4 = () => {
  return (
    <div className="redaktus-component" data-component-type="profile4">
        ...
        <div className="mx-auto w-full max-w-[400px] overflow-hidden rounded-lg bg-white p-4 pb-8 shadow-card dark:bg-dark-2">
          <div className="relative">
            <div className="h-[180px] overflow-hidden rounded-sm">
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-04/cover.jpg"}
            ...
            <div className="relative z-10 mx-auto -mt-[68px] h-[136p] w-full max-w-[136px] overflow-hidden rounded-full bg-white/20 p-2">
              ...
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/profiles/profile-04/profile.png"}
                alt={props.imageAlt || "profile"}
