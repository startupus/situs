/**
 * DashboardDropdown2 - DashboardDropdown компонент
 * 
...
interface DashboardDropdown2Props {
  target: string;
}

const DashboardDropdown2: React.FC<DashboardDropdown2Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="dashboarddropdown2">) => document.removeEventListener("click", clickHandler);
  });
