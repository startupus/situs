            ...
            <div ref={domNode} className='w-full px-4 sm:w-1/2 lg:w-1/4'>
              <div className='py-8 text-center'>
                <div className='relative inline-block mb-8 text-left'>
                  ...
                  >
                    <DropdownItem label='Dashboard' href={props.href || "/#"} />
                    <DropdownItem label='Preview' href={props.href || "/#"} />
                    <DropdownItem label='Button' href={props.href || "/#"} />
                    <DropdownItem label='Subscribe' href={props.href || "/#"} />
                  </div>
                </div>
              </div>
            </div>
...
const DropdownItem = ({ label, href }) => {
  return (
    <div className="redaktus-component" data-component-type="dropdown3">
    <a
      href={href}
