/**
 * DataStats3 - DataStats компонент
 * 
...
const DataStats3: React.FC<DataStats3Props> = () => {
  return (
...
const DataStatsCard = ({ icon, totalTitle, total, increment, decrement }) => {
  return (
    <div className="redaktus-component" data-component-type="datastats3">
