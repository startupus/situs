/**
 * DataStats5 - DataStats компонент
 * 
...
interface DataStats5Props {
  icon: string;
  name: string;
  number: string;
}

const DataStats5: React.FC<DataStats5Props> = () => {
  return (
...
const DataStatsCard = ({ icon, name, number }) => {
  return (
    <div className="redaktus-component" data-component-type="datastats5">
