/**
 * DataStats8 - DataStats компонент
 * 
...
const DataStats8: React.FC<DataStats8Props> = () => {
  return (
...
const DataStatsCard = ({ totalTitle, total, increment, decrement }) => {
  return (
    <div className="redaktus-component" data-component-type="datastats8">
