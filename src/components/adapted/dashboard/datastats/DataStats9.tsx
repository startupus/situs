/**
 * DataStats9 - DataStats компонент
 * 
...
const DataStats9: React.FC<DataStats9Props> = () => {
  return (
...
const DataStatsCard = ({ icon, color, name, number }) => {
  return (
    <div className="redaktus-component" data-component-type="datastats9">
