/**
 * DataStats7 - DataStats компонент
 * 
...
const DataStats7: React.FC<DataStats7Props> = () => {
  return (
...
const DataStatsCard = ({ children, name, number, icon }) => {
  return (
    <div className="redaktus-component" data-component-type="datastats7">
