/**
 * DataStats2 - DataStats компонент
 * 
...
const DataStats2: React.FC<DataStats2Props> = () => {
  return (
...
const DataStatsCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="datastats2">
