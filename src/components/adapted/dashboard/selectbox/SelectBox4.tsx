/**
 * SelectBox4 - SelectBox компонент
 * 
...
interface SelectBox4Props {
  id: string;
  title: string;
}

const SelectBox4: React.FC<SelectBox4Props> = () => {
  return (
...
const SelectBoxItem = ({ id, title }) => {
  ...
  return (
    <div className="redaktus-component" data-component-type="selectbox4">
    <div>
      <input
        type="checkbox"
        name="select-list"
