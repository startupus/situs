...
const ChatBox4: React.FC<ChatBox4Props> = () => {
  const active = true;
          ...
          <div className="flex items-center justify-between border-b border-stroke px-[30px] py-4 dark:border-dark-3">
            <div className="flex items-center">
              <div className="relative mr-5 h-[56px] w-full max-w-[56px] rounded-full">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/chat-box/chat-box-04/image-01.jpg"}
...
const Chat = ({ width, time, text }) => {
  return (
    <div className="redaktus-component" data-component-type="chatbox4">
