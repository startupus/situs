/**
 * ChatBox3 - ChatBox компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: DashboardComponents
 * Подкатегория: ChatBox
 * 
 * @component
 * @example
 * <ChatBox3 
...
const ChatBox3: React.FC<ChatBox3Props> = () => {
  const pictures = [
          ...
          <div className="flex items-center justify-between border-b border-stroke px-5 py-[18px] dark:border-dark-3 sm:px-[30px]">
            <div className="flex items-center">
              <div className="mr-4 h-[50px] w-full max-w-[50px] overflow-hidden rounded-full">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/chat-box/chat-box-03/image-01.jpg"}
            ...
            <div className="flex items-center justify-end">
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/chat-box/chat-box-03/image-02.jpg"}
                alt={props.imageAlt || "avatar"}
                className="h-8 w-8 rounded-full border-2 border-white object-cover object-center dark:border-dark-3"
              />
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/chat-box/chat-box-03/image-03.jpg"}
                alt={props.imageAlt || "avatar"}
                className="-ml-[10px] h-8 w-8 rounded-full border-2 border-white object-cover object-center dark:border-dark-3"
              />
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/dashboard/images/chat-box/chat-box-03/image-04.jpg"}
                alt={props.imageAlt || "avatar"}
                className="-ml-[10px] h-8 w-8 rounded-full border-2 border-white object-cover object-center dark:border-dark-3"
              />
...
const Chat = ({ img, name, time, text, audio, pictures }) => {
  return (
    <div className="redaktus-component" data-component-type="chatbox3">
            ...
            {pictures.map((picture, index) => {
              return (
                <img
                  key={index}
                  src={picture}
                  alt={props.imageAlt || "chat box image"}
