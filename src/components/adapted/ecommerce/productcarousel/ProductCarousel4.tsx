/**
 * ProductCarousel4 - ProductCarousel компонент
 * 
...
const ProductCarousel4: React.FC<ProductCarousel4Props> = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="productcarousel4">
    <>
  ...
  return (
    <div className="rounded-[5px] border-[.5px] border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 p-[10px] shadow-1 dark:shadow-box-dark">
      <a href={link} className="block">
        <img src={image} alt={props.imageAlt || "product"} className="w-full rounded-[5px]" />
      </a>
