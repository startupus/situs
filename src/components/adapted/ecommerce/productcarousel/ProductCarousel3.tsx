/**
 * ProductCarousel3 - ProductCarousel компонент
 * 
...
const ProductCarousel3: React.FC<ProductCarousel3Props> = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="productcarousel3">
    <>
