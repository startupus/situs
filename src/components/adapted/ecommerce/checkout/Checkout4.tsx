...
const Checkout4: React.FC<Checkout4Props> = () => {
  return (
    <>
                ...
                <div className="mb-10 overflow-hidden rounded-[10px] border border-stroke bg-white px-6 py-10 shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark sm:px-10">
                  ...
                  <div className="-mx-3 flex flex-wrap">
                    <div className="w-1/2 px-3">
                      <div>
                        <img
                          src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/checkout/checkout-04/card-01.svg"}
                          alt={props.imageAlt || "card"}
                          className="w-full"
                        />
                      </div>
                    </div>
                    <div className="w-1/2 px-3">
                      <div>
                        <img
                          src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/checkout/checkout-04/card-02.svg"}
                          alt={props.imageAlt || "card"}
                          className="w-full"
                        />
                      </div>
...
const CartItem = ({ img, title, quantity, price }) => {
  return (
    <div className="redaktus-component" data-component-type="checkout4">
    <div className="mb-9 flex items-center">
      <div className="mr-6 h-[90px] w-full max-w-[80px] overflow-hidden rounded-lg border border-stroke dark:border-dark-3 sm:h-[110px] sm:max-w-[100px]">
        <img src={img} alt={props.imageAlt || "product image"} className="w-full" />
      </div>
      ...
      <div className="mb-3">
        ...
        >
          <div className="mr-4 w-full max-w-[40px] sm:max-w-[65px]">
            <img src={img} alt={props.imageAlt || "fedex"} />
          </div>
