...
const Checkout2: React.FC<Checkout2Props> = () => {
  return (
...
const CartItem = ({ img, title, subtitle, price }) => {
  return (
    <div className="redaktus-component" data-component-type="checkout2">
...
const ShippingOption = ({ name, id, img, price, title }) => {
  return (
    <div className="mb-4 w-full px-3 md:w-1/2 lg:w-full xl:w-1/2">
      ...
      >
        <div className="mr-4">
          <img src={img} alt={props.imageAlt || "shipping"} />
        </div>
