/**
 * RecentProduct5 - RecentProduct компонент
 * 
...
const RecentProduct5: React.FC<RecentProduct5Props> = () => {
  return (
...
const ProductCard = ({ subtitle, title, details, link, img, bgColor }) => {
  return (
    <div className="redaktus-component" data-component-type="recentproduct5">
    <>
