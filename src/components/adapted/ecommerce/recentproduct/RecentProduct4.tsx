/**
 * RecentProduct4 - RecentProduct компонент
 * 
...
const RecentProduct4 = () => {
  return (
    <div className="redaktus-component" data-component-type="recentproduct4">
        ...
        <div className="-mx-4 flex flex-wrap items-center justify-center">
          ...
          <div className="w-full px-4 lg:w-1/2 2xl:w-5/12">
            <div className="rounded-3xl border-8 border-white bg-white shadow-testimonial-6 dark:shadow-box-dark">
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products/recent-products-04/product-01.jpg"}
                alt={props.imageAlt || "Recent Product"}
