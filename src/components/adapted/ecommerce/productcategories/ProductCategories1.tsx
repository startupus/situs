/**
 * ProductCategories1 - ProductCategories компонент
 * 
...
interface ProductCategories1Props {
  link: string;
  img: string;
  title: string;
  subtitle: string;
...
const ProductCategories = () => {
  return (
    <div className="redaktus-component" data-component-type="productcategories1">
