/**
 * ProductCategories5 - ProductCategories компонент
 * 
...
const ProductCategories5: React.FC<ProductCategories5Props> = () => {
  return (
...
const CategoriesItem = ({ link, img, title, subtitle, details, button }) => {
  return (
    <div className="redaktus-component" data-component-type="productcategories5">
