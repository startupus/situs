/**
 * FeaturedProduct3 - FeaturedProduct компонент
 * 
...
interface FeaturedProduct3Props {
  img: string;
  link: string;
  subtitle: string;
  title: string;
...
const FeaturedProduct3: React.FC<FeaturedProduct3Props> = () => {
  return (
...
const SingleFeaturedProduct = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="featuredproduct3">
