/**
 * FeaturedProduct2 - FeaturedProduct компонент
 * 
...
interface FeaturedProduct2Props {
  img: string;
  link: string;
  rating: string;
  title: string;
...
const FeaturedProduct2: React.FC<FeaturedProduct2Props> = () => {
  return (
...
const SingleFeaturedProduct = ({ img, link, rating, title, price, big }) => {
  return (
    <div className="redaktus-component" data-component-type="featuredproduct2">
    <div
