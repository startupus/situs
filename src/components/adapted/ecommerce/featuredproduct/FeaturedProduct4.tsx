/**
 * FeaturedProduct4 - FeaturedProduct компонент
 * 
...
interface FeaturedProduct4Props {
  img: string;
  link: string;
  title: string;
  price: string;
...
const FeaturedProduct4: React.FC<FeaturedProduct4Props> = () => {
  return (
...
const SingleFeaturedProduct = ({ img, link, title, price }) => {
  return (
    <div className="redaktus-component" data-component-type="featuredproduct4">
    <div className="mb-10">
      <div className="mb-6">
