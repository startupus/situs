/**
 * QuickView4 - QuickView компонент
 * 
...
interface QuickView4Props {
  target: string;
}

const QuickView4: React.FC<QuickView4Props> = () => {
  ...
  const useClickOutside = (refs, isOpen, setIsOpen) => {
    useEffect(() => {
      ...
      return (
    <div className="redaktus-component" data-component-type="quickview4">) => document.removeEventListener("click", clickHandler);
                  ...
                  >
                    ...
                    <div className="items-center lg:flex">
                      <div className="mb-12 w-full lg:mb-0 lg:max-w-[500px]">
                        <img
                          src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/quick-views/quick-view-04/image-01.jpg"}
