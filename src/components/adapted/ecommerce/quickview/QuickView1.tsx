/**
 * QuickView1 - QuickView компонент
 * 
...
const QuickView = () => {
  ...
  const useClickOutside = (refs, isOpen, setIsOpen) => {
    useEffect(() => {
      ...
      return (
    <div className="redaktus-component" data-component-type="quickview1">) => document.removeEventListener("click", clickHandler);
                        ...
                        <Swiper slidesPerView={1} loop={true} ref={sliderRef}>
                          <SwiperSlide>
                            <div className="overflow-hidden rounded-lg">
                              <img
                                src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/quick-views/quick-view-01/image-01.jpg"}
                          ...
                          <SwiperSlide>
                            <div className="overflow-hidden rounded-lg">
                              <img
                                src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/quick-views/quick-view-01/image-02.jpg"}
                                alt={props.imageAlt || "product"}
                                className="w-full"
                              />
                            </div>
