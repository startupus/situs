/**
 * QuickView2 - QuickView компонент
 * 
...
interface QuickView2Props {
  target: string;
}

const QuickView2: React.FC<QuickView2Props> = () => {
  ...
  const useClickOutside = (refs, isOpen, setIsOpen) => {
    useEffect(() => {
      ...
      return (
    <div className="redaktus-component" data-component-type="quickview2">) => document.removeEventListener("click", clickHandler);
                  ...
                  >
                    ...
                    <div className="items-center lg:flex">
                      <div className="mb-12 w-full lg:mb-0 lg:max-w-[450px]">
                        <img
                          src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/quick-views/quick-view-02/image-01.jpg"}
