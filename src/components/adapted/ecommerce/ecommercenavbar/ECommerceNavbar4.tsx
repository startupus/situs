/**
 * ECommerceNavbar4 - ECommerceNavbar компонент
 * 
...
interface ECommerceNavbar4Props {
  link: string;
  name: string;
}

const ECommerceNavbar4: React.FC<ECommerceNavbar4Props> = () => {
  return (
    <>
...
const TopNavItem = ({ link, name }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercenavbar4">
    <li>
      <a
        href={link}
