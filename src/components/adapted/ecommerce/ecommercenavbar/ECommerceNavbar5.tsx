/**
 * ECommerceNavbar5 - ECommerceNavbar компонент
 * 
...
interface ECommerceNavbar5Props {
  target: string;
}

const ECommerceNavbar5: React.FC<ECommerceNavbar5Props> = () => {
  ...
  const useClickOutside = (refs, isOpen, setIsOpen) => {
    useEffect(() => {
      ...
      return (
    <div className="redaktus-component" data-component-type="ecommercenavbar5">) => document.removeEventListener("click", clickHandler);
                  ...
                  <div className="w-full">
                    ...
                    >
                      <ul className="block items-center lg:flex">
                        <ListItem NavLink="/#" menuName="Home" />
                        <ListItem NavLink="/#" menuName="Shop" />
                        <ListItem NavLink="/#" menuName="Products" submenu>
                          <SubmenuGroup />
                        </ListItem>
                        <ListItem NavLink="/#" menuName="Accessories" />
                        <ListItem NavLink="/#" menuName="Contact" />
                      </ul>
                    </nav>
                  </div>
                </div>
...
export default ECommerceNavbar5;
...
const ListItem = ({ children, NavLink, menuName, submenu }) => {
  const [open, setOpen] = useState(false);
  ...
  useClickOutside([menuTrigger], open, setOpen);
