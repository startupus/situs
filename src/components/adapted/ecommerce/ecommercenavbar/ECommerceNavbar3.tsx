/**
 * ECommerceNavbar3 - ECommerceNavbar компонент
 * 
...
interface ECommerceNavbar3Props {
  link: string;
  name: string;
}

const ECommerceNavbar3: React.FC<ECommerceNavbar3Props> = () => {
  return (
    <>
...
const TopNavItem = ({ link, name }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercenavbar3">
    <li>
      <a
        href={link}
