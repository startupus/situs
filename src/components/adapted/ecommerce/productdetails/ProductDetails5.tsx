/**
 * ProductDetails5 - ProductDetails компонент
 * 
...
interface ProductDetails5Props {
  id: string;
  price: string;
  title: string;
}

const ProductDetails5: React.FC<ProductDetails5Props> = () => {
  return (
            ...
            <div>
              <div className="rounded-[10px] border border-stroke dark:border-dark-3 bg-white dark:bg-dark-2">
                <div className="overflow-hidden rounded-md p-5">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-05/image-01.jpg"}
            ...
            <div className="rounded-[10px] bg-white dark:bg-dark-2">
              ...
              <div className="p-8">
                ...
                <p className="mb-[10px] flex text-base font-medium gap-1">
                  ...
                  <a href={props.href || "/#"} className="text-primary">
                    Tailwind
                  </a>
                </p>
...
const DownloadOption = ({ id, price, title }) => {
  return (
    <div className="redaktus-component" data-component-type="productdetails5">
