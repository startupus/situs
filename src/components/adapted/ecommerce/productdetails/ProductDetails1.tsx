/**
 * ProductDetails1 - ProductDetails компонент
 * 
...
const ProductDetails = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="productdetails1">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-7/12">
            <div className="mb-12 lg:mb-0 lg:mr-5 xl:mr-10">
              <div className="mb-8 overflow-hidden rounded-lg">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/big-image-01.jpg"}
                  alt={props.imageAlt || "products-details"}
                  className={`${productOne ? "block" : "hidden"} w-full`}
                />
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/big-image-02.jpg"}
                  alt={props.imageAlt || "products-details"}
                  className={`${productTwo ? "block" : "hidden"} w-full`}
                />
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/big-image-03.jpg"}
                  alt={props.imageAlt || "products-details"}
              ...
              <div className="-mx-4 flex items-center justify-between">
                <div className="w-1/3 px-4">
                  ...
                  >
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/thumbnail-01.jpg"}
                ...
                <div className="w-1/3 px-4">
                  ...
                  >
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/thumbnail-02.jpg"}
                      alt={props.imageAlt || "thumbnail-01"}
                      className="w-full"
                    />
                  </button>
                ...
                <div className="w-1/3 px-4">
                  ...
                  >
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-01/thumbnail-03.jpg"}
                      alt={props.imageAlt || "thumbnail-01"}
                      className="w-full"
                    />
                  </button>
