/**
 * ProductDetails4 - ProductDetails компонент
 * 
...
const ProductDetails4 = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="productdetails4">
          ...
          <div className="w-full px-4 xl:w-10/12">
            <div className="relative mb-10">
              <div className="relative overflow-hidden rounded-lg">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-04/image-01.jpg"}
                ...
                />
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-04/image-02.jpg"}
                  alt={props.imageAlt || "products-details"}
                  className={`${
                ...
                />
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-04/image-03.jpg"}
                  alt={props.imageAlt || "products-details"}
                  className={`${
