/**
 * ProductDetails2 - ProductDetails компонент
 * 
...
interface ProductDetails2Props {
  target: string;
}

const ProductDetails2: React.FC<ProductDetails2Props> = () => {
  ...
  const useClickOutside = (refs, isOpen, setIsOpen) => {
    useEffect(() => {
      ...
      return (
    <div className="redaktus-component" data-component-type="productdetails2">) => document.removeEventListener("click", clickHandler);
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 lg:mb-0 lg:mr-5 xl:mr-10">
                <div className="relative mb-5 overflow-hidden">
                  ...
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/big-image-01.jpg"}
                    alt={props.imageAlt || "products-details"}
                    className={`${productOne ? "block" : "hidden"} w-full rounded-md`}
                  />
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/big-image-02.jpg"}
                    alt={props.imageAlt || "products-details"}
                    className={`${productTwo ? "block" : "hidden"} w-full rounded-md`}
                  />
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/big-image-03.jpg"}
                    alt={props.imageAlt || "products-details"}
                    className={`${productThree ? "block" : "hidden"} w-full rounded-md`}
                  />
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/big-image-04.jpg"}
                    alt={props.imageAlt || "products-details"}
                ...
                <div className="-mx-2 flex items-center justify-between">
                  <div className="w-1/4 px-2">
                    ...
                    >
                      <img
                        src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/thumbnail-01.jpg"}
                  ...
                  <div className="w-1/4 px-2">
                    ...
                    >
                      <img
                        src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/thumbnail-02.jpg"}
                        alt={props.imageAlt || "thumbnail-01"}
                        className="w-full"
                      />
                    </button>
                  ...
                  <div className="w-1/4 px-2">
                    ...
                    >
                      <img
                        src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/thumbnail-03.jpg"}
                        alt={props.imageAlt || "thumbnail-01"}
                        className="w-full"
                      />
                    </button>
                  ...
                  <div className="w-1/4 px-2">
                    ...
                    >
                      <img
                        src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/products-details/details-02/thumbnail-04.jpg"}
                        alt={props.imageAlt || "thumbnail-01"}
                        className="w-full"
                      />
                    </button>
