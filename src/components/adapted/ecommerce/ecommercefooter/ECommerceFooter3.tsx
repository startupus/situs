/**
 * ECommerceFooter3 - ECommerceFooter компонент
 * 
...
interface ECommerceFooter3Props {
  children: string;
  header: string;
}

const ECommerceFooter3: React.FC<ECommerceFooter3Props> = () => {
  return (
    <>
        ...
        <div className="relative z-10 pt-20 lg:pt-24">
          <div className="container mx-auto">
            <div className="-mx-4 flex flex-wrap">
              ...
              <LinkGroup header="Top Categories">
                <NavLink link="/#" name="Televisions" />
                <NavLink link="/#" name="Washing Machines" />
                <NavLink link="/#" name="Air Conditioners" />
                <NavLink link="/#" name="Laptops" />
                <NavLink link="/#" name="Accessories" />
              </LinkGroup>
              <LinkGroup header="Important Links">
                <NavLink link="/#" name="About us" />
                <NavLink link="/#" name="Contact Us" />
                <NavLink link="/#" name="Faq" />
                <NavLink link="/#" name="Latest Posts" />
            ...
            <div className="-mx-4 flex flex-wrap items-center justify-center">
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-1/3">
                <div className="mx-auto mb-5 lg:mb-0">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/footers/footer-03/payment.svg"}
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-3/12 xl:w-1/3">
                <div className="mb-5 flex items-center justify-center space-x-[18px] md:justify-end lg:mb-0">
                  ...
                  <a href={props.href || "/#"} className="text-white/50 hover:text-white">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
...
export default ECommerceFooter3;

const LinkGroup = ({ children, header }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercefooter3">
    <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-2/12">
      <div className="mb-16">
        <h3 className="pb-5 text-xl font-semibold text-white">{header}</h3>
        <span className="mb-8 block h-[3px] w-10 rounded-sm bg-white"></span>
