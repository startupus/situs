/**
 * ECommerceFooter2 - ECommerceFooter компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: EcommerceComponents
 * Подкатегория: ECommerceFooter
 * 
 * @component
 * @example
 * <ECommerceFooter2 
...
const ECommerceFooter2: React.FC<ECommerceFooter2Props> = () => {
  return (
    <>
      <footer className="pt-[100px] dark:bg-dark">
          ...
          <div className="rounded-lg border border-stroke bg-gray px-6 pb-6 pt-20 dark:border-dark-3 dark:bg-dark-2 sm:px-8 xl:px-14">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4 md:w-5/12 lg:w-1/3">
                <div className="mb-14">
                  <a href={props.href || "/#"} className="mb-8 inline-block">
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/logo/logo.svg"}
                      alt={props.imageAlt || ""}
                      className="max-w-full dark:hidden"
                    />
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/logo/logo-white.svg"}
                      alt={props.imageAlt || ""}
                  ...
                  <div className="flex items-center space-x-3">
                    <a
                      href={props.href || "/#"}
                      className="flex h-8 w-8 items-center justify-center rounded-full border-[.5px] border-stroke bg-white text-body-color transition-all hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:bg-dark dark:text-dark-6"
                    >
                      <svg
                        width="16"
                        height="16"
              ...
              <div className="w-full px-4 md:w-7/12 lg:w-1/3">
                <div className="mb-14">
                  ...
                  <div className="-mx-4 flex flex-wrap space-y-3 sm:space-y-0 lg:space-y-3 xl:space-y-0">
                    ...
                    <LinkGroup>
                      <NavLink link="/#" name="Women" />
                      <NavLink link="/#" name="Accessories" />
                      <NavLink link="/#" name="Men" />
                      <NavLink link="/#" name="Gift" />
                    </LinkGroup>
                  </div>
                </div>
              </div>
            ...
            <div className="-mx-4 flex flex-wrap items-center">
              <div className="w-full px-4 xl:w-8/12">
                <div className="-mx-3 flex flex-wrap justify-center xl:justify-start">
                  <BottomLink href={props.href || "/#"} name="Payment" />
                  <BottomLink href={props.href || "/#"} name="Shipping &amp; Returns" />
                  <BottomLink href={props.href || "/#"} name="Gift Cards" />
                  <BottomLink href={props.href || "/#"} name="Privacy Policy" />
                  <BottomLink href={props.href || "/#"} name="Stockists" />
                </div>
              </div>
              <div className="w-full px-4 xl:w-4/12">
                <div className="mt-2 xl:mb-4 xl:mt-0">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/footers/footer-02/payment.svg"}
                    alt={props.imageAlt || "payment"}
...
const LinkGroup = ({ children }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercefooter2">
