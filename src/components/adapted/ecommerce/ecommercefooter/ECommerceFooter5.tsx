/**
 * ECommerceFooter5 - ECommerceFooter компонент
 * 
...
interface ECommerceFooter5Props {
  children: string;
  header: string;
}

const ECommerceFooter5: React.FC<ECommerceFooter5Props> = () => {
  return (
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercefooter5">
