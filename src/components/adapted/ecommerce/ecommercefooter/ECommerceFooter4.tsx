/**
 * ECommerceFooter4 - ECommerceFooter компонент
 * 
...
interface ECommerceFooter4Props {
  icon: string;
  title: string;
  subtitle: string;
}

const ECommerceFooter4: React.FC<ECommerceFooter4Props> = () => {
  return (
          ...
          <div className="-mx-4 flex flex-wrap">
            <FooterTopItem
              icon={
                ...
                >
                  <path
                    d="M29.085 5.5H13.46C12.8195 5.5 12.2052 5.75444 11.7523 6.20734C11.2994 6.66024 11.045 7.2745 11.045 7.915V8.135H4.295C4.04953 8.13619 3.80922 8.20554 3.60086 8.33532C3.39251 8.4651 3.2243 8.65021 3.115 8.87L0.64 13.92C0.549844 14.1002 0.501964 14.2985 0.5 14.5V22.325C0.5 22.5902 0.605357 22.8446 0.792893 23.0321C0.98043 23.2196 1.23478 23.325 1.5 23.325H2.855C3.00737 24.2132 3.46881 25.0189 4.15778 25.5997C4.84674 26.1805 5.71886 26.4991 6.62 26.4991C7.52114 26.4991 8.39326 26.1805 9.08222 25.5997C9.77119 25.0189 10.2326 24.2132 10.385 23.325H20.885C21.0374 24.2132 21.4988 25.0189 22.1878 25.5997C22.8767 26.1805 23.7489 26.4991 24.65 26.4991C25.5511 26.4991 26.4233 26.1805 27.1122 25.5997C27.8012 25.0189 28.2626 24.2132 28.415 23.325H30.15C30.5038 23.3251 30.8434 23.1863 31.0959 22.9385C31.3483 22.6907 31.4934 22.3537 31.5 22V7.925C31.5013 7.60702 31.4398 7.2919 31.319 6.99775C31.1983 6.70359 31.0206 6.43618 30.7962 6.21087C30.5718 5.98556 30.3052 5.80677 30.0115 5.68478C29.7178 5.56279 29.403 5.5 29.085 5.5ZM4.725 10.145H11.045V13.42H3.115L4.725 10.145ZM6.62 24.5C6.25764 24.501 5.90314 24.3944 5.60143 24.1937C5.29972 23.993 5.06439 23.7072 4.92526 23.3726C4.78614 23.038 4.74948 22.6697 4.81993 22.3142C4.89038 21.9588 5.06477 21.6322 5.321 21.376C5.57723 21.1198 5.90377 20.9454 6.25922 20.8749C6.61467 20.8045 6.98303 20.8411 7.31762 20.9803C7.65222 21.1194 7.93797 21.3547 8.13867 21.6564C8.33938 21.9581 8.44599 22.3126 8.445 22.675C8.44368 23.1586 8.25098 23.622 7.90901 23.964C7.56704 24.306 7.10361 24.4987 6.62 24.5ZM6.62 18.845C5.83948 18.8467 5.07815 19.0871 4.43821 19.534C3.79828 19.9808 3.31038 20.6128 3.04 21.345H2.5V15.42H11.045V21.325H10.2C9.928 20.5947 9.43939 19.9649 8.7996 19.5199C8.1598 19.0749 7.39934 18.8359 6.62 18.835V18.845ZM24.645 24.5C24.2826 24.501 23.9281 24.3944 23.6264 24.1937C23.3247 23.993 23.0894 23.7072 22.9503 23.3726C22.8111 23.038 22.7745 22.6697 22.8449 22.3142C22.9154 21.9588 23.0898 21.6322 23.346 21.376C23.6022 21.1198 23.9288 20.9454 24.2842 20.8749C24.6397 20.8045 25.008 20.8411 25.3426 20.9803C25.6772 21.1194 25.963 21.3547 26.1637 21.6564C26.3644 21.9581 26.471 22.3126 26.47 22.675C26.4687 23.1586 26.276 23.622 25.934 23.964C25.592 24.306 25.1286 24.4987 24.645 24.5ZM29.5 21.325H28.225C27.9541 20.5931 27.4656 19.9617 26.8251 19.5159C26.1846 19.07 25.4229 18.8309 24.6425 18.8309C23.8621 18.8309 23.1004 19.07 22.4599 19.5159C21.8194 19.9617 21.3309 20.5931 21.06 21.325H13.06V7.925C13.0613 7.81534 13.1054 7.71053 13.183 7.63299C13.2605 7.55544 13.3653 7.5113 13.475 7.51H29.085C29.1947 7.5113 29.2995 7.55544 29.377 7.63299C29.4546 7.71053 29.4987 7.81534 29.5 7.925V21.325Z"
                    fill="#3758F9"
                  />
                </svg>
              }
              title="Free delivery"
              subtitle="Lorem ipsum dolor sit amet, consect adipiscing eliteget lorem."
            />
            <FooterTopItem
              icon={
                <svg
                ...
                >
                  <path
                    d="M27.6 9.50001H26.1C26.25 9.10001 26.35 8.65001 26.35 8.15001V6.45001C26.35 4.45001 24.75 2.85001 22.75 2.85001H4.5C2.5 2.85001 0.9 4.45001 0.9 6.45001V8.15001V25.6C0.9 27.55 2.45 29.1 4.4 29.1H27.65C29.6 29.1 31.15 27.55 31.15 25.6V13C31.1 11.1 29.55 9.50001 27.6 9.50001ZM28.85 22.05H24.3C24.1 22.05 23.9 21.85 23.9 21.65V17C23.9 16.8 24.1 16.6 24.3 16.6H28.85V22.05ZM3.15 6.45001C3.15 5.70001 3.75 5.10001 4.5 5.10001H22.8C23.55 5.10001 24.15 5.70001 24.15 6.45001V8.15001C24.15 8.90001 23.55 9.50001 22.8 9.50001H4.5C3.75 9.50001 3.15 8.90001 3.15 8.15001V6.45001ZM27.6 26.9H4.4C3.7 26.9 3.15 26.35 3.15 25.65V11.5C3.55 11.65 4 11.75 4.5 11.75H27.65C28.35 11.75 28.9 12.3 28.9 13V14.35H24.35C22.9 14.35 21.7 15.55 21.7 17V21.6C21.7 23.05 22.9 24.25 24.35 24.25H28.9V25.6C28.85 26.3 28.3 26.9 27.6 26.9Z"
                    fill="#3758F9"
                  />
                  <path
                    d="M26.5 20.25C27.0247 20.25 27.45 19.8247 27.45 19.3C27.45 18.7753 27.0247 18.35 26.5 18.35C25.9753 18.35 25.55 18.7753 25.55 19.3C25.55 19.8247 25.9753 20.25 26.5 20.25Z"
                    fill="#3758F9"
                  />
                </svg>
              }
            ...
            <FooterTopItem
              icon={
                ...
                >
                  <path
                    d="M4.2 14.5C4.35 14.5 4.55 14.45 4.7 14.4L10.25 12.45C10.85 12.25 11.15 11.6 10.95 11C10.75 10.4 10.1 10.1 9.5 10.3L6.05 11.5C7.7 7.19999 11.9 4.29999 16.7 4.29999C21.95 4.29999 26.5 7.79999 27.8 12.8C27.95 13.4 28.55 13.75 29.15 13.6C29.75 13.45 30.1 12.85 29.95 12.25C28.4 6.24999 22.95 2.04999 16.65 2.04999C11.05 2.04999 6.1 5.34999 4.05 10.3L3 7.29999C2.8 6.69999 2.15 6.39999 1.55 6.59999C0.950004 6.79999 0.650004 7.44999 0.850004 8.04999L2.75 13.5C3.05 14.15 3.6 14.5 4.2 14.5Z"
                    fill="#3758F9"
                  />
                  <path
                    d="M31.05 24.85L29 19.5C28.85 19.15 28.6 18.85 28.25 18.7C27.9 18.55 27.5 18.55 27.15 18.7L21.65 20.8C21.05 21 20.8 21.65 21 22.25C21.2 22.85 21.85 23.1 22.45 22.9L25.9 21.6C23.9 25.25 20 27.65 15.65 27.65C10.7 27.65 6.35001 24.55 4.80001 19.95C4.60001 19.35 3.95001 19.05 3.40001 19.25C2.80001 19.45 2.50001 20.1 2.70001 20.65C4.55001 26.15 9.75001 29.85 15.65 29.85C20.8 29.85 25.45 27 27.8 22.6L28.95 25.65C29.1 26.1 29.55 26.35 30 26.35C30.15 26.35 30.25 26.35 30.4 26.25C31 26.1 31.25 25.45 31.05 24.85Z"
                    fill="#3758F9"
                  />
                </svg>
              }
      ...
      <div className="pt-[70px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            ...
            <LinkGroup header="Shop Departments">
              <NavLink link="/#" name="Computers & Accessories" />
              <NavLink link="/#" name="Smartphones & Tablets" />
              <NavLink link="/#" name="TV, Video & Audio  " />
              <NavLink link="/#" name="Cameras, Photo & Video" />
            </LinkGroup>
      ...
      <div className="border-t border-stroke py-8 dark:border-dark-3">
        <div className="container mx-auto">
          <div className="text-center">
            <div className="mb-5">
              <img
                src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/footers/footer-04/payment.svg"}
...
export default ECommerceFooter4;

const FooterTopItem = ({ icon, title, subtitle }) => {
  return (
    <div className="redaktus-component" data-component-type="ecommercefooter4">
