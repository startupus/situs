/**
 * ECommerceFooter1 - ECommerceFooter компонент
 * 
...
const ECommerceFooter = () => {
  return (
    <div className="redaktus-component" data-component-type="ecommercefooter1">
    <>
            ...
            <div className="-mx-4 flex flex-wrap">
              ...
              <div className="w-full px-4 lg:w-1/2">
                <div className="flex items-center justify-center lg:justify-end">
                  ...
                  <div>
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/footers/footer-01/payments.svg"}
                      alt={props.imageAlt || "payments"}
