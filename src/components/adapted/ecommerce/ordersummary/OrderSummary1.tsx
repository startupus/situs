/**
 * OrderSummary1 - OrderSummary компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: EcommerceComponents
 * Подкатегория: OrderSummary
 * 
 * @component
 * @example
 * <OrderSummary1 
...
const OrderSummary = () => {
  return (
    <div className="redaktus-component" data-component-type="ordersummary1">
              ...
              <div className="bg-white dark:bg-dark-2 shadow-testimonial-6 dark:shadow-box-dark overflow-hidden rounded-[10px] border border-stroke dark:border-dark-3 p-10">
                ...
                <div className="mb-8 flex items-center">
                  <div className="mr-5 h-20 w-full max-w-[80px] rounded-sm overflow-hidden">
                    <img
                      src={props.imageSrc || "https://cdn-tailgrids.b-cdn.net/1.0/assets/images/ecommerce/order-summaries/order-summary-01/customer.jpg"}
                      alt={props.imageAlt || "customer"}
