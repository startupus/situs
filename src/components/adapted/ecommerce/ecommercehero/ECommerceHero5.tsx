/**
 * ECommerceHero5 - ECommerceHero компонент
 * 
...
const ECommerceHero5 = () => {
  return (
    <div className="redaktus-component" data-component-type="ecommercehero5">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative z-10 my-20 text-center">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/ecommerce/headers/header-05/image-01.png"}
