/**
 * CustomerReview5 - CustomerReview компонент
 * 
...
const CustomerReview5: React.FC<CustomerReview5Props> = () => {
  return (
...
const ReviewItem = ({ img, name, date, rating, title, details, replyItem }) => {
  return (
    <div className="redaktus-component" data-component-type="customerreview5">
