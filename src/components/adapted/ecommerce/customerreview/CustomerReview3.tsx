/**
 * CustomerReview3 - CustomerReview компонент
 * 
...
const CustomerReview3: React.FC<CustomerReview3Props> = () => {
  return (
...
const ReviewItem = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="customerreview3">
    <div className="mb-9 overflow-hidden rounded-lg bg-white shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
