/**
 * CustomerReview2 - CustomerReview компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: EcommerceComponents
 * Подкатегория: CustomerReview
 * 
 * @component
 * @example
 * <CustomerReview2 
...
const CustomerReview2: React.FC<CustomerReview2Props> = () => {
  return (
    <>
...
const ReviewItem = ({ img, name, date, rating, title, details }) => {
  return (
    <div className="redaktus-component" data-component-type="customerreview2">
