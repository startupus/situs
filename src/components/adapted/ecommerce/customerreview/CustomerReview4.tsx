/**
 * CustomerReview4 - CustomerReview компонент
 * 
...
const CustomerReview4: React.FC<CustomerReview4Props> = () => {
  return (
...
const ReviewItem = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="customerreview4">
