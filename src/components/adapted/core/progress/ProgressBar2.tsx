/**
 * ProgressBar2 - Progress компонент
 * 
...
const ProgressBar2 = () => {
  return (
    <div className="redaktus-component" data-component-type="progressbar2">
      ...
      <div className='mb-12'>
        <div className='bg-stroke dark:bg-dark-3 relative h-2.5 w-full rounded-2xl'>
          <div className='bg-primary absolute top-0 left-0 h-full w-1/2 rounded-2xl'>
            <span className='bg-primary absolute -right-4 bottom-full mb-2 rounded-xs px-3.5 py-1 text-sm text-white'>
              <span className='bg-primary absolute bottom-[-2px] left-1/2 -z-10 h-2 w-2 -translate-x-1/2 rotate-45 rounded-xs'></span>
              50%
            </span>
          </div>
        </div>
