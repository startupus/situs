/**
 * WhiteOutlineButtonWithIcon - Buttons компонент
 * 
...
const WhiteOutlineButtonWithIcon = () => {
  return (
    <div className="redaktus-component" data-component-type="whiteoutlinebuttonwithicon">
    <button className='text-body-color border-stroke hover:border-primary hover:text-primary inline-flex items-center justify-center border bg-white py-3 px-6 text-center text-base font-medium'>
...
export default WhiteOutlineButtonWithIcon
