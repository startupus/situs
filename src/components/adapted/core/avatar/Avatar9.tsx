...
const Avatar9: React.FC<Avatar9Props> = () => {
  return (
    <>
...
const AvatarItem = ({ img, name, arrow, active, children }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="avatar9">) => document.removeEventListener('click', clickHandler)
  })
