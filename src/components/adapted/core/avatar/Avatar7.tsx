...
const Avatar7: React.FC<Avatar7Props> = () => {
  return (
    <>
...
const AvatarItem = ({ img }) => {
  return (
    <div className="redaktus-component" data-component-type="avatar7">
    <div className='group group-first:ml-0 -ml-5 h-[60px] w-[60px] rounded-full border-4 border-white dark:border-dark-3'>
      <img
        src={img}
