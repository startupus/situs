/**
 * StickyBar3 - StickyBars компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: CoreComponents
 * Подкатегория: StickyBars
 * 
 * @component
 * @example
 * <StickyBar3 
...
export default function StickyBar3() {
  return (
    <section>
      <div className="w-full bg-linear-to-l from-[#27F090] via-[#7F41F3] to-[#F59527] px-4 md:px-10">
        <div className="relative pr-6">
          <p className="py-3 text-center text-sm font-semibold text-white md:text-base">
            On Sale For A Very Limited Time!
            <a href={props.href || "#"} className="pl-1 underline">
              Get it now→
            </a>
          </p>
