/**
 * Pagination3 - Paginations компонент
 * 
...
export default function Pagination3() {
  return (
    <div className="bg-white py-10 text-center dark:bg-dark">
      <div className="mb-12 inline-flex justify-center rounded-sm bg-white p-3 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.13)] dark:bg-dark-2">
