/**
 * FileUpload3 - FileUploads компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: CoreComponents
 * Подкатегория: FileUploads
 * 
 * @component
 * @example
 * <FileUpload3 
  ...
  return (
    <section className="bg-white py-20 dark:bg-dark">
      <div className="container">
        <div className="relative mx-auto w-full max-w-[570px] rounded-[20px] bg-white p-4 shadow-lg dark:bg-dark-2">
          <div className="relative z-10 flex min-h-[328px] items-center justify-center overflow-hidden rounded-2xl border border-dashed border-stroke bg-gray-1 p-6 dark:border-dark-3 dark:bg-white/5 md:p-10">
            <label for="">
              <input type="file" className="sr-only" />
              <div className="mx-auto mb-5 flex aspect-square w-[68px] items-center justify-center rounded-full bg-gray-3 text-dark dark:bg-dark dark:text-dark-7">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 28 28"
              ...
              <div className="mx-auto w-full max-w-[290px] text-center">
                ...
                <p className="mb-5 text-base text-dark-4 dark:text-dark-6">
                  Drag and drop your PNG, JPG, WebP, SVG images here or browse
                </p>
                <button className="text-base font-medium text-primary underline underline-offset-2">
                  Browse File
                </button>
              </div>
            </label>
            <div className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 dark:opacity-30">
              <img
                src={props.imageSrc || "./images/file-upload/grid-shape-1.svg"}
                alt={props.imageAlt || "grid-shape-1"}
              />
            </div>
          </div>
        </div>
