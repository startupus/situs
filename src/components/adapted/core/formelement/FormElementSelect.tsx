/**
 * FormElementSelect - FormElement компонент
 * 
...
const FormElementSelect: React.FC<FormElementSelectProps> = () => {
  return (
...
const DefaultColumn = ({ children }) => {
  return (
    <div className="redaktus-component" data-component-type="formelementselect">
