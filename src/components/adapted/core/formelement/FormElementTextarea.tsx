/**
 * FormElementTextarea - FormElement компонент
 * 
...
interface FormElementTextareaProps {
  children: string;
}

const FormElementTextarea: React.FC<FormElementTextareaProps> = () => {
  return (
...
const DefaultColumn = ({ children }) => {
  return (
    <div className="redaktus-component" data-component-type="formelementtextarea">
