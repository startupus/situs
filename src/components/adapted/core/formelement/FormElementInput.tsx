/**
 * FormElementInput - FormElement компонент
 * 
...
const FormElementInput: React.FC<FormElementInputProps> = () => {
  return (
...
const DefaultColumn = ({ children }) => {
  return (
    <div className="redaktus-component" data-component-type="formelementinput">
