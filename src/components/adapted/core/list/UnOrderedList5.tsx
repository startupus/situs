...
interface UnOrderedList5Props {
  text: string;
}

const UnOrderedList5: React.FC<UnOrderedList5Props> = () => {
  return (
...
const ListItem = ({ text }) => {
  return (
    <div className="redaktus-component" data-component-type="unorderedlist5">
