...
interface UnOrderedList4Props {
  text: string;
}

const UnOrderedList4: React.FC<UnOrderedList4Props> = () => {
  return (
...
const ListItem = ({ text }) => {
  return (
    <div className="redaktus-component" data-component-type="unorderedlist4">
