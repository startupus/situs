...
interface UnOrderedList3Props {
  text: string;
}

const UnOrderedList3: React.FC<UnOrderedList3Props> = () => {
  return (
...
const ListItem = ({ text }) => {
  return (
    <div className="redaktus-component" data-component-type="unorderedlist3">
