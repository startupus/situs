...
interface UnOrderedList6Props {
  text: string;
}

const UnOrderedList6: React.FC<UnOrderedList6Props> = () => {
  return (
...
const ListItem = ({ text }) => {
  return (
    <div className="redaktus-component" data-component-type="unorderedlist6">
