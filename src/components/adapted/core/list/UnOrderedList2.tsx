...
interface UnOrderedList2Props {
  text: string;
}

const UnOrderedList2: React.FC<UnOrderedList2Props> = () => {
  return (
...
const ListItem = ({ text }) => {
  return (
    <div className="redaktus-component" data-component-type="unorderedlist2">
