/**
 * PromptToImageFour - PromptToImage компонент
 * 
            ...
            <div className="w-full">
              ...
              <div className="space-y-8">
                <div className="flex aspect-490/254 w-full items-center justify-center overflow-hidden rounded-lg border border-gray-5 bg-gray-2 text-dark-7 dark:border-dark-3">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/7p3gMqp/image-1.jpg"}
                    alt={props.imageAlt || "result text"}
                    className="h-full w-full object-cover object-center"
                  />
                </div>
                <div className="flex aspect-490/254 w-full items-center justify-center overflow-hidden rounded-lg border border-gray-5 bg-gray-2 text-dark-7 dark:border-dark-3">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/smQS8CF/image-2.jpg"}
                    alt={props.imageAlt || "result text"}
                    className="h-full w-full object-cover object-center"
                  />
                </div>
