/**
 * VideoGeneratorTwo - VideoGenerator компонент
 * 
 * Адаптировано из TailGrids Pro для редактора Редактус
 * Категория: AiComponents
 * Подкатегория: VideoGenerator
 * 
 * @component
 * @example
 * <VideoGeneratorTwo 
          ...
          <div className="rounded-xl border border-stroke bg-white p-8 dark:border-dark-3 dark:bg-dark-2">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="relative my-8 aspect-square overflow-hidden rounded-2xl">
                <img
                  src={props.imageSrc || "https://i.ibb.co/jwRYkr6/image-1.jpg"}
                  alt={props.imageAlt || "video cover"}
              ...
              <div className="relative my-8 aspect-square overflow-hidden rounded-2xl">
                <img
                  src={props.imageSrc || "https://i.ibb.co/nnqGWMs/image-2.jpg"}
                  alt={props.imageAlt || "video cover"}
                  className="w-full object-cover object-center"
                />
