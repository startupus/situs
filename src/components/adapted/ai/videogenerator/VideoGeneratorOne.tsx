/**
 * VideoGeneratorOne - VideoGenerator компонент
 * 
...
function VideoGeneratorOne() {
  return (
    <section className="bg-gray-2 py-20 dark:bg-dark">
      <div className="container">
        <div className="mx-auto w-full max-w-[920px]">
          <div className="rounded-2xl bg-white p-8 shadow-md dark:bg-dark-2">
            ...
            <div className="relative my-8 aspect-860/400 overflow-hidden rounded-2xl">
              <img
                src={props.imageSrc || "https://i.ibb.co/VM8gmsr/image-1.jpg"}
              ...
              <button className="absolute right-4 top-4 inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-base font-medium text-white duration-200 hover:bg-primary/90">
                Download Video
                <span>
                  <svg
                    width="20"
...
export default VideoGeneratorOne;
