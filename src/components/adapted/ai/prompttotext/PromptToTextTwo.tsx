/**
 * PromptToTextTwo - PromptToText компонент
 * 
        ...
        <div className="mx-auto w-full max-w-[970px] rounded-2xl bg-white p-8 dark:bg-dark-2">
          ...
          <div>
            ...
            <div className="flex items-center gap-3.5">
              <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-transparent bg-primary py-2 pl-3.5 pr-[18px] text-base font-medium text-white hover:bg-primary/90">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-primary py-2 pl-3.5 pr-[18px] text-primary hover:bg-primary hover:text-white">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_2201_2352)">
                    <path
...
export default PromptToTextTwo;
