    ...
    <>
      ...
      <section className="relative z-10 overflow-hidden bg-dark pb-[140px] pt-20 lg:pb-[180px] lg:pt-[120px]">
        ...
        <div className="absolute bottom-0 left-0 -z-10 max-lg:hidden">
          <img src={props.imageSrc || "./images/hero-06/shape-1.svg"} alt={props.imageAlt || "shape-1"} />
        </div>
        <div className="absolute bottom-14 left-1/2 -translate-x-1/2">
          <img src={props.imageSrc || "./images/hero-06/lines.svg"} alt={props.imageAlt || "lines shape"} />
        </div>
        <div className="absolute bottom-0 right-0 -z-10 max-lg:hidden">
          <img src={props.imageSrc || "./images/hero-06/shape-2.svg"} alt={props.imageAlt || "shape-2"} />
        </div>
      </section>
    </>
  )
