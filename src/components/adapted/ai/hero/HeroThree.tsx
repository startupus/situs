            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="flex gap-6">
                <div className="*:w-full *:rounded-[10px] flex w-1/2 flex-col gap-y-6">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/yYdb2rd/image-1.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                  <img
                    src={props.imageSrc || "https://i.ibb.co/Jx729Ly/image-2.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                  <img
                    src={props.imageSrc || "https://i.ibb.co/4M7Cnrv/image-3.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                </div>
                ...
                <div className="*:w-full *:rounded-[10px] flex w-1/2 flex-col gap-y-6">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/pyRQB2r/image-4.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                  <img
                    src={props.imageSrc || "https://i.ibb.co/KWmdNPp/image-5.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                  <img
                    src={props.imageSrc || "https://i.ibb.co/RCYVVSG/image-6.jpg"}
                    alt={props.imageAlt || "hero image"}
                  />
                </div>
              </div>
