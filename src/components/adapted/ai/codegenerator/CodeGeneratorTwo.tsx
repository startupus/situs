/**
 * CodeGeneratorTwo - CodeGenerator компонент
 * 
        ...
        <div className="mx-auto w-full max-w-[1100px] space-y-12">
          ...
          <div className="rounded-xl border border-stroke bg-white p-8 dark:border-dark-3 dark:bg-dark-2">
            <div className="mb-6 flex items-center justify-between">
              ...
              <button className="inline-flex items-center gap-2 text-base text-dark hover:text-primary dark:text-white">
                <span>
                  <svg
                    width="18"
                    height="18"
                  ...
                  >
                    <path
                      d="M15.9187 3.71249L12.9656 0.787494C12.7687 0.590619 12.4875 0.478119 12.2062 0.478119H7.08749C6.27186 0.478119 5.59686 1.15312 5.59686 1.96874V12.2344C5.59686 13.05 6.27186 13.725 7.08749 13.725H14.7375C15.5531 13.725 16.2281 13.05 16.2281 12.2344V4.47187C16.2281 4.19062 16.1156 3.90937 15.9187 3.71249ZM13.0219 2.64374L14.0906 3.71249H13.0219V2.64374ZM14.7375 12.4594H7.08749C6.97499 12.4594 6.86249 12.3469 6.86249 12.2344V1.96874C6.86249 1.85624 6.97499 1.74374 7.08749 1.74374H11.7562V4.33124C11.7562 4.66874 12.0375 4.97812 12.4031 4.97812H14.9625V12.2625C14.9625 12.375 14.85 12.4594 14.7375 12.4594Z"
                      fill="currentColor"
                    />
                    <path
                      d="M12.4031 6.32812H8.69058C8.35308 6.32812 8.0437 6.60937 8.0437 6.975C8.0437 7.34062 8.32495 7.62187 8.69058 7.62187H12.4031C12.7406 7.62187 13.05 7.34062 13.05 6.975C13.05 6.60937 12.7406 6.32812 12.4031 6.32812Z"
                      fill="currentColor"
                    />
                    <path
                      d="M12.4031 8.69061H8.69058C8.35308 8.69061 8.0437 8.97186 8.0437 9.33749C8.0437 9.67499 8.32495 9.98436 8.69058 9.98436H12.4031C12.7406 9.98436 13.05 9.70311 13.05 9.33749C13.0218 8.97186 12.7406 8.69061 12.4031 8.69061Z"
                      fill="currentColor"
                    />
                    <path
                      d="M11.7562 14.625C11.4187 14.625 11.1094 14.9062 11.1094 15.2719V16.0312C11.1094 16.1438 10.9969 16.2562 10.8844 16.2562H3.26248C3.14998 16.2562 3.03748 16.1438 3.03748 16.0312V5.7375C3.03748 5.625 3.14998 5.5125 3.26248 5.5125H4.21873C4.55623 5.5125 4.8656 5.23125 4.8656 4.86562C4.8656 4.5 4.58435 4.21875 4.21873 4.21875H3.26248C2.44685 4.21875 1.77185 4.89375 1.77185 5.70937V16.0312C1.77185 16.8469 2.44685 17.5219 3.26248 17.5219H10.9125C11.7281 17.5219 12.4031 16.8469 12.4031 16.0312V15.2719C12.4031 14.9062 12.1219 14.625 11.7562 14.625Z"
                      fill="currentColor"
                    />
                  </svg>
                </span>
...
export default CodeGeneratorTwo;
