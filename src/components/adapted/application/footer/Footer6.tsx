...
const Footer6: React.FC<Footer6Props> = () => {
  return (
    <footer className="relative z-10 bg-primary pb-10 pt-20 lg:pb-20 lg:pt-[120px]">
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#13C296" stopOpacity="0.34" />
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="redaktus-component" data-component-type="footer6">
    <>
