...
const Footer7: React.FC<Footer7Props> = () => {
  return (
                ...
                <form className="flex flex-wrap">
                  <div className="relative mb-3 mr-5 w-full max-w-[370px]">
                    <input
                      ...
                      className="h-[52px] w-full rounded-md border border-white/[.08] bg-white/5 pl-14 pr-5 text-white placeholder-dark-8 outline-hidden focus:border-white/40 focus-visible:shadow-none"
                    />
...
const LinkGroup = ({ children, header }) => {
  return (
    <div className="redaktus-component" data-component-type="footer7">
