...
const Footer2 = () => {
  return (
    <div className="redaktus-component" data-component-type="footer2">
        ...
        <div className="-mx-4 flex flex-wrap lg:mb-14">
          <div className="w-full px-4 md:w-2/3 lg:w-1/3">
            <div className="mb-12 w-full">
              <h4 className="text-3xl font-medium text-dark dark:text-white xl:text-[32px]">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-3/12 xl:w-1/3">
              <div className="w-full py-3 text-center lg:text-left">
                <a href={props.href || "/#"} className="inline-block max-w-[160px]">
                  <img
