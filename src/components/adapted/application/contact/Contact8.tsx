...
const Contact8: React.FC<Contact8Props> = () => {
  return (
...
const InputBox = ({ type, placeholder, name, labelTitle }) => {
  return (
    <div className="redaktus-component" data-component-type="contact8">
    <div className="w-full px-4 md:w-1/2">
      <div className="mb-7">
        ...
        <input
          ...
          name={name}
          className="w-full border border-stroke bg-transparent px-6 py-4 text-body-color placeholder-secondary-color outline-hidden focus:border-primary dark:border-dark-3 dark:text-dark-6"
        />
      </div>
    </div>
  );
    ...
    <div className="w-full px-4">
      <div className="mb-7">
        ...
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="w-full resize-none border border-stroke bg-transparent px-6 py-4 text-body-color placeholder-secondary-color outline-hidden focus:border-primary dark:border-dark-3 dark:text-dark-6"
