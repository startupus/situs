...
const Modal4: React.FC<Modal4Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="modal4">) => document.removeEventListener("click", clickHandler);
  });
      ...
      >
        ...
        >
          <div className="mb-9 overflow-hidden rounded-md border border-stroke dark:border-dark-3">
            <img
              src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/application/images/modals/image-01.svg"}
