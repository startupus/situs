...
function Modal9() {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="modal9">) => document.removeEventListener("click", clickHandler);
  });
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-5">
                    <div className="aspect-square w-[52px] overflow-hidden rounded-full">
                      <img
                        src={props.imageSrc || "https://i.ibb.co/VCdHCxg/image-1.jpg"}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-5">
                    <div className="aspect-square w-[52px] overflow-hidden rounded-full">
                      <img
                        src={props.imageSrc || "https://i.ibb.co/cLjs5Xb/image-2.jpg"}
                        alt={props.imageAlt || "modal image"}
                        className="w-full object-cover object-center"
                      />
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-5">
                    <div className="aspect-square w-[52px] overflow-hidden rounded-full">
                      <img
                        src={props.imageSrc || "https://i.ibb.co/dDjRX8P/image-3.jpg"}
                        alt={props.imageAlt || "modal image"}
                        className="w-full object-cover object-center"
                      />
                    </div>
