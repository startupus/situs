/**
 * TableGrid3 - TableGrid компонент
 * 
...
const TableGrid3: React.FC<TableGrid3Props> = () => {
  return (
...
const TableGridItem = ({ image, name, details, color, price, link }) => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="tablegrid3">) => document.removeEventListener("click", clickHandler);
  });
