/**
 * TableGrid4 - TableGrid компонент
 * 
...
const TableGrid4: React.FC<TableGrid4Props> = () => {
  return (
...
const TableGridItem = ({ image, price, link, title, review }) => {
  return (
    <div className="redaktus-component" data-component-type="tablegrid4">
