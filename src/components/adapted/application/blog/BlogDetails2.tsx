...
const BlogDetails2: React.FC<BlogDetails2Props> = () => {
  return (
    <>
        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div className="relative z-20 mb-[60px] overflow-hidden rounded-sm">
                <img
                  src={props.imageSrc || "https://i.ibb.co/0Dm67HR/image-01.jpg"}
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="w-full px-4 lg:w-8/12">
                  <div>
                    ...
                    <div className="relative z-10 mb-10 overflow-hidden rounded-sm bg-primary/5 p-10 text-center md:px-[60px]">
                ...
                <div className="w-full px-4 lg:w-4/12">
                  <div>
                    <div className="relative mb-12 overflow-hidden rounded-sm bg-primary px-11 py-[60px] text-center lg:px-8">
                      ...
                      <form>
                        ...
                        <input
                          type="submit"
                          value="Subscribe Now"
                          className="mb-6 w-full cursor-pointer rounded-sm bg-secondary p-3 text-center text-sm font-medium text-white transition hover:bg-secondary/90"
                        />
                      </form>
                    ...
                    <div className="mb-12 overflow-hidden rounded-sm">
                      <img
                        src={props.imageSrc || "https://i.ibb.co/bbjDccf/bannder-ad.jpg"}
                        alt={props.imageAlt || "image"}
                        className="w-full"
                      />
                    </div>
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <RelatedArticleItem
              image="https://i.ibb.co/X71KYxk/image-01.jpg"
              date="Dec 22, 2025"
              title="Meet AutoManage, the best AI management tools"
              description="Lorem Ipsum is simply dummy text of the printing and typesetting industry."
            />
            <RelatedArticleItem
              image="https://i.ibb.co/MBZ0nh6/image-02.jpg"
              date="Mar 15, 2025"
              title="How to earn more money as a wellness coach"
              description="Lorem Ipsum is simply dummy text of the printing and typesetting industry."
            />
            <RelatedArticleItem
              image="https://i.ibb.co/b5KdHx2/image-03.jpg"
              date="Jan 05, 2026"
...
const PopularArticleItem = ({ image, title, authorName }) => {
  return (
    <div className="redaktus-component" data-component-type="blogdetails2">
      ...
      <div className="mb-5 flex w-full items-center border-b border-stroke pb-5 dark:border-dark-3">
        ...
        <div className="w-full">
          <h4>
            <a
              href={props.href || "#"}
              className="mb-1 inline-block text-lg font-medium leading-snug text-dark hover:text-primary dark:text-white lg:text-base xl:text-lg"
            >
              {title}
            </a>
          </h4>
...
const RelatedArticleItem = ({ image, date, title, description }) => {
  return (
