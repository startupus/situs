...
const Error4 = () => {
  return (
    <div className="redaktus-component" data-component-type="error4">
    <section className="relative z-10 flex min-h-screen items-center justify-center overflow-hidden bg-white py-10 dark:bg-dark">
      <div className="container mx-auto">
        <div className="mx-auto w-full max-w-[570px] text-center">
          <span className="text-[100px] font-extrabold text-primary sm:text-[150px]">
            404
          </span>
          <h2 className="mb-3 text-2xl font-bold text-dark dark:text-white sm:text-4xl">
            Sorry, the page can't be found
          </h2>
          <p className="mx-auto mb-8 max-w-[490px] text-base text-body-color dark:text-dark-6">
          ...
          <a
            href={props.href || "/#"}
            className="rounded-sm bg-primary px-8 py-3 text-base font-medium text-white hover:bg-primary/90"
          >
            Back to homepage
          </a>
        </div>
