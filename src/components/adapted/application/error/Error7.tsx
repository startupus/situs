...
const Error7 = () => {
  return (
    <div className="redaktus-component" data-component-type="error7">
      ...
      <div className="container mx-auto">
        <div className="mx-auto max-w-[600px] rounded-[10px] bg-white p-10 text-center shadow-1 dark:bg-dark-2 dark:shadow-card md:px-[70px] md:py-[55px]">
          <div className="mx-auto mb-14 text-center">
            <img
              src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/application/images/404/image-07.svg"}
