...
const Error2 = () => {
  return (
    <div className="redaktus-component" data-component-type="error2">
    <section className="flex min-h-screen items-center justify-center bg-white dark:bg-dark">
