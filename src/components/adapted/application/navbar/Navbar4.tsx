...
const Navbar4: React.FC<Navbar4Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="navbar4">) => document.removeEventListener("click", clickHandler);
  });
