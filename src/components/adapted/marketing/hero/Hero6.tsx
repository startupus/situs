...
const Hero6: React.FC<Hero6Props> = () => {
  return (
    <>
      <Navbar />
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="mx-auto text-center">
                <div className="relative z-10 mt-16 inline-block lg:mt-0">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-06.svg"}
                    alt={props.imageAlt || "hero"}
                    className="mx-auto max-w-full"
                  />
                  <div className="absolute -left-10 -top-10 z-[-1]">
                    <img
                      src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/hero/hero6-shape-1.svg"}
                      alt={props.imageAlt || "shape"}
                    />
                  </div>
...
const Navbar = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="hero6">
    <header
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <a
                href={props.href || "/#"}
                className="px-5 py-2 text-base font-medium text-dark hover:text-primary dark:text-white"
              >
                Sign in
              </a>
