...
const Hero5: React.FC<Hero5Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="hero5">) => document.removeEventListener("click", clickHandler);
  });
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4">
              <div className="relative z-10 mx-auto max-w-[845px]">
                <div className="mt-16">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-05.jpg"}
        ...
        <div className="relative -mx-4 flex items-center justify-between">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <a
                href={props.href || "/#"}
                className="inline-block px-5 py-2 text-base font-medium text-white hover:opacity-50"
              >
                Sign in
              </a>
