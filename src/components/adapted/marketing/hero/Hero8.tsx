          ...
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4 lg:w-7/12">
              <div className="mx-auto text-center">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-08.svg"}
...
const Navbar = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="hero8">
    <>
