...
const Hero = () => {
  return (
    <div className="redaktus-component" data-component-type="hero1">
    <>
      <Navbar />
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="lg:ml-auto lg:text-right">
                <div className="relative z-10 inline-block pt-11 lg:pt-0">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/1.0/assets/images/hero/hero-image-01.png"}
  ...
  return (
    <>
      <a href={href} className="flex w-full items-center justify-center">
        <img src={imgSrc} alt={props.imageAlt || "brand image"} className="h-10 w-full" />
      </a>
    </>
  );
};
