            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="lg:ml-auto lg:text-right">
                <div className="absolute right-0 top-1/2 z-[-1] hidden w-1/2 -translate-y-1/2 md:block lg:w-full">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-03.png"}
...
const Navbar = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="hero3">
