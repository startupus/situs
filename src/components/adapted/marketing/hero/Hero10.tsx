            ...
            <div className="w-full px-4 lg:w-6/12 xl:w-7/12">
              <div className="lg:ml-auto lg:text-right">
                <div className="absolute right-0 top-0 z-[-1] hidden h-full lg:inline-block">
                  <img
                    src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-10.png"}
...
const Navbar = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="hero10">
    <>
