...
const Hero9: React.FC<Hero9Props> = () => {
  return (
    <>
      <Navbar />
...
const Navbar = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="hero9">
          ...
          <div className="flex w-full items-center justify-between px-4">
            ...
            <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
              <div className="flex items-center justify-end">
                <a href={props.href || "/#"} className="ml-5 text-white hover:opacity-70">
                  <svg
                    width="10"
                    height="18"
                    viewBox="0 0 10 18"
