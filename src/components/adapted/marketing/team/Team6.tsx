...
const Team6: React.FC<Team6Props> = () => {
  return (
...
const TeamCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="team6">
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-1/3 xl:w-1/4">
        <div className="group mb-8 bg-white dark:bg-dark-2">
          <div className="relative">
            <img src={imageSrc} alt={props.imageAlt || "team"} className="w-full" />
