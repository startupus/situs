...
const Team4: React.FC<Team4Props> = () => {
  return (
...
const TeamCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="team4">
    <div className="w-full px-4 lg:w-1/2">
      <div className="mx-auto mb-10 max-w-[320px] items-stretch sm:flex sm:max-w-full">
        <div className="mr-9 w-full overflow-hidden rounded-sm sm:max-w-[200px]">
          <img src={imageSrc} alt={props.imageAlt || "image"} className="w-full" />
        </div>
