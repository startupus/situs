...
const Team2: React.FC<Team2Props> = () => {
  return (
...
const TeamCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="team2">
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-1/4">
        <div className="mb-10">
          <div className="[h-170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
            <img src={imageSrc} alt={props.imageAlt || ""} className="w-full rounded-full" />
