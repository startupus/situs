/**
 * Portfolio7 - Portfolio компонент
 * 
        ...
        <div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-7">
            <div className="w-full md:col-span-2">
              <img
                src={props.imageSrc || "https://i.ibb.co/wddhDTZ/image-1.jpg"}
                alt={props.imageAlt || ""}
            ...
            <div className="space-y-6 md:col-span-3">
              <div>
                <img
                  src={props.imageSrc || "https://i.ibb.co/Jpr6cwK/image-2.jpg"}
                  alt={props.imageAlt || ""}
                  className="w-full overflow-hidden rounded-xl object-cover object-center"
                />
              </div>
              <div>
                <img
                  src={props.imageSrc || "https://i.ibb.co/thFy0nr/image-3.jpg"}
                  alt={props.imageAlt || ""}
                  className="w-full overflow-hidden rounded-xl object-cover object-center"
                />
              </div>
            ...
            <div className="md:col-span-2">
              <img
                src={props.imageSrc || "https://i.ibb.co/zX86hvz/image-4.jpg"}
                alt={props.imageAlt || ""}
                className="w-full overflow-hidden rounded-xl object-cover object-center"
              />
            </div>
