/**
 * Portfolio6 - Portfolio компонент
 * 
...
const Portfolio6: React.FC<Portfolio6Props> = () => {
  return (
    <>
      <style>
        {`
...
const PortfolioCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="portfolio6">
