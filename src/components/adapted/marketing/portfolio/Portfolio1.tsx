/**
 * Portfolio1 - Portfolio компонент
 * 
...
const Portfolio = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="portfolio1">
    <>
      ...
      >
        <div className="relative mb-12">
          <div className="overflow-hidden rounded-[10px]">
            <img src={ImageHref} alt={props.imageAlt || "portfolio"} className="w-full" />
          </div>
