/**
 * Portfolio4 - Portfolio компонент
 * 
...
const Portfolio4: React.FC<Portfolio4Props> = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="portfolio4">
    <>
