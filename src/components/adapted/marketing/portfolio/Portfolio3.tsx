/**
 * Portfolio3 - Portfolio компонент
 * 
...
const Portfolio3: React.FC<Portfolio3Props> = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="portfolio3">
    <>
        ...
        <div className="border-stroke dark:border-dark-3 items-center justify-between overflow-hidden border lg:flex">
          ...
          <div className="text-center">
            <div className="relative z-10 inline-block">
              <img src={image} alt={props.imageAlt || "image"} className="mx-auto lg:ml-auto" />
