...
const Pricing6: React.FC<Pricing6Props> = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <PricingCard
            type="Free Lite"
            subscription="It's totally free"
          ...
          >
            ...
            <List disable>Community Support</List>
            <List disable>Downloadable Files</List>
          </PricingCard>
          <PricingCard
            type="Starter"
            subscription="Single Site"
            subtitle="One time Payment"
            prevPrice="39$"
            price="29$"
            button="Purchase Now"
...
const PricingCard = ({
  ...
  return (
    <div className="redaktus-component" data-component-type="pricing6">
    <>
              ...
              <div>
                ...
                {second && (
                  ...
                  >
                    ...
                    />
                    <path
                      d="M17 16.0437C18.8063 16.0437 20.2938 14.5562 20.2938 12.75C20.2938 10.9437 18.8063 9.45624 17 9.45624C15.1938 9.45624 13.7063 10.9437 13.7063 12.75C13.7063 14.5562 15.1938 16.0437 17 16.0437ZM17 11.8469C17.4782 11.8469 17.9032 12.2719 17.9032 12.75C17.9032 13.2281 17.4782 13.6531 17 13.6531C16.5219 13.6531 16.0969 13.2281 16.0969 12.75C16.0969 12.2719 16.5219 11.8469 17 11.8469Z"
                      fill="#3758F9"
                    />
                  </svg>
                )}
        ...
        {disable ? (
          ...
          >
            <g clipPath="url(#clip0_1676_331)">
              ...
              />
              <path
                d="M12.6874 7.09374L8.96868 10.7187L7.28118 9.06249C6.99993 8.78124 6.56243 8.81249 6.28118 9.06249C5.99993 9.34374 6.03118 9.78124 6.28118 10.0625L8.28118 12C8.46868 12.1875 8.71868 12.2812 8.96868 12.2812C9.21868 12.2812 9.46868 12.1875 9.65618 12L13.6874 8.12499C13.9687 7.84374 13.9687 7.40624 13.6874 7.12499C13.4062 6.84374 12.9687 6.84374 12.6874 7.09374Z"
                fill="#22AD5C"
              />
            </g>
            <defs>
              <clipPath id="clip0_1676_331">
                <rect width="20" height="20" fill="white" />
              </clipPath>
            </defs>
          </svg>
