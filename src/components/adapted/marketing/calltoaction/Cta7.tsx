...
const Cta7 = () => {
  return (
    <div className="redaktus-component" data-component-type="cta7">
    <>
      <section className="relative z-10 bg-dark">
        <div className="left-0 top-0 h-full lg:absolute lg:w-1/2">
          <img
            src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/cta/image-03.jpg"}
          ...
          <div className="-mx-4 flex flex-wrap lg:justify-end">
            <div className="w-full px-4 lg:w-1/2">
              <div className="py-20 lg:px-0 lg:py-[120px] xl:px-10 2xl:px-20">
                <span className="mb-4 block text-lg font-medium text-gray-7">
                ...
                <p className="mb-10 text-base leading-relaxed text-gray-7 lg:mb-12">
                  ...
                  eiusmod tempor incididunt ut labore dolore magna utenim minim
                  veniam nostrud exercitation ullamco laboris nisi ut aliquip ex
