...
const Video2 = () => {
  ...
  return (
    <div className="redaktus-component" data-component-type="video2">
      ...
      <div>
        <div className="right-0 top-0 z-10 h-full w-full lg:absolute lg:w-1/2">
          <div className="flex h-full w-full items-center justify-center">
            <img
              src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/videos/image-02.jpg"}
