...
const ServiceCard = ({ icon, title, details, btnText, btnLink }) => {
  return (
    <div className="redaktus-component" data-component-type="services2">
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className="group mb-12">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary xl:mb-[50px]">
