        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 lg:w-6/12 xl:w-6/12">
            <div className="relative overflow-hidden rounded-2xl">
              <img
                src={props.imageSrc || "https://i.ibb.co/3kvc93z/image-1.jpg"}
                alt={props.imageAlt || "service image"}
              ...
              <div className="absolute bottom-0 left-0 flex h-full w-full items-end bg-linear-to-t from-[#000] to-transparent">
                <div className="p-5 sm:p-11">
                  <a
                    href={props.href || "#"}
                    className="mb-3 block text-3xl font-bold text-white hover:text-primary sm:text-4xl"
                  >
                    UX & UI Design with Development
                  </a>
                  <p className="mb-6 text-base text-gray-3">
                    Lorem Ipsum is simply dummy text of the printing global
                    tech. 
                  </p>
                  <a
                    href={props.href || "#"}
          ...
          <div className="flex h-full w-full flex-col px-4 md:w-full md:flex-row md:gap-8 lg:mt-8 xl:mt-0 xl:w-3/12 xl:flex-col xl:gap-0">
            <div className="relative z-10 mb-8 flex h-full min-h-[250px] flex-col justify-between overflow-hidden rounded-2xl bg-primary p-6 2xl:min-h-[295px]">
              <p className="text-gray-3">
                Lorem Ipsum is simply dummy text of the printing text to the
                global tech.
              </p>
              <div className="flex items-end justify-between">
              ...
              <div className="absolute right-0 top-0 -z-10">
                <img
                  src={props.imageSrc || "./images/services/services-10/dots-shape.svg"}
            ...
            <div className="relative z-10 flex h-full min-h-[250px] flex-col justify-between overflow-hidden rounded-2xl bg-dark p-6 dark:bg-dark-2 2xl:min-h-[295px]">
              ...
              <div className="absolute bottom-0 left-0 -z-10">
                <img
                  src={props.imageSrc || "./images/services/services-10/dots-shape-2.svg"}
                  alt={props.imageAlt || "dots-shape"}
                />
              </div>
            </div>
