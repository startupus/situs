...
const About3 = () => {
  return (
    <div className="redaktus-component" data-component-type="about3">
    <>
          ...
          <div className="-mx-4 mb-10 flex flex-wrap items-center lg:mb-[60px]">
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4 sm:w-1/2">
                  <div className="mb-10">
                    ...
                    <h3 className="text-dark dark:text-white mb-3 text-xl font-semibold 2xl:text-[22px]">
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="flex justify-center">
                <img
                  src={props.imageSrc || "https://cdn.tailgrids.com/2.0/image/marketing/images/about/about-03/image-01.svg"}
