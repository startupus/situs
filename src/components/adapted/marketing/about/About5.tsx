...
const About5 = () => {
  return (
    <div className="redaktus-component" data-component-type="about5">
    <>
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="relative mx-auto flex h-[500px] max-w-[440px]">
                <div className="absolute left-0 z-30 mr-14 max-w-[270px] rounded-lg">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/CvVpnCZ/image-01.jpg"}
                ...
                <div className="absolute right-0 top-20 z-30 ml-14 max-w-[300px] rounded-lg">
                  <img
                    src={props.imageSrc || "https://i.ibb.co/qpHSL3Z/image-02.jpg"}
                    alt={props.imageAlt || "about image"}
                    className="w-full rounded-lg"
                  />
                </div>
