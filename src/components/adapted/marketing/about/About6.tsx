...
const About6: React.FC<About6Props> = () => {
  ...
  useEffect(() => {
    ...
    return (
    <div className="redaktus-component" data-component-type="about6">) => document.removeEventListener("click", clickHandler);
  });
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="flex items-center justify-center w-full h-full">
                <img
                  src={props.imageSrc || "https://i.ibb.co/3T9rRM3/video-thumbnail.jpg"}
