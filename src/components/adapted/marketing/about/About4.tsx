...
const About4 = () => {
  return (
    <div className="redaktus-component" data-component-type="about4">
    <>
              ...
              <div className="flex flex-wrap -mx-2 sm:-mx-4 lg:-mx-2 xl:-mx-4">
                <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  <div className="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                    <img
                      src={props.imageSrc || "https://i.ibb.co/8mB6K20/image-01.jpg"}
                ...
                <div className="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                  <div className="mb-4 sm:mb-8 sm:h-[220px] md:h-[346px] lg:mb-4 lg:h-[225px] xl:mb-8 xl:h-[310px]">
                    <img
                      src={props.imageSrc || "https://i.ibb.co/fp6kRJc/image-02.jpg"}
                      alt={props.imageAlt || "about image"}
                      className="object-cover object-center w-full h-full"
                    />
                  </div>
