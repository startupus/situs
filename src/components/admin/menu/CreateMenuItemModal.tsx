    ...
    <div className="fixed inset-0 bg-dark/90 flex items-center justify-center z-50 px-4 py-5">
      <div className="bg-white dark:bg-dark-2 rounded-[20px] w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center p-8 pb-6">
          <h3 className="text-2xl font-semibold text-dark dark:text-white">Создать пункт меню</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-8 pb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {/* Alias */}
            <div>
              <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Alias (URL) *</label>
              <input
                type="text"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            {/* Тип пункта меню */}
            <div>
              <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Тип пункта</label>
              <div className="relative z-20">
                ...
                >
                  ...
                  <option value="URL" className="dark:bg-dark-2">
                    Внешняя ссылка
                  </option>
                  <option value="HEADING" className="dark:bg-dark-2">
                    Заголовок группы
                  </option>
                  <option value="SEPARATOR" className="dark:bg-dark-2">
                    Разделитель
                  </option>
                </select>
          ...
          {formData.type === 'COMPONENT' && (
            <div className="border border-primary/20 dark:border-primary/30 rounded-lg p-6 bg-primary/5 dark:bg-primary/10 mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-lg font-medium text-dark dark:text-white">Настройки компонента</h4>
              </div>

              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Компонент */}
                <div>
                  <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Компонент *</label>
                  <div className="relative z-20">
                    ...
                    >
                      ...
                      <option value="Website" className="dark:bg-dark-2">
                        Website
                      </option>
                      <option value="Store" className="dark:bg-dark-2">
                        Store
                      </option>
                      <option value="Blog" className="dark:bg-dark-2">
                        Blog
                      </option>
                      <option value="Landing" className="dark:bg-dark-2">
                        Landing
                      </option>
                    </select>
                    <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">
                ...
                {/* View */}
                <div>
                  <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">View *</label>
                  <div className="relative z-20">
                    <select
                      value={formData.view || ''}
                ...
                {/* Параметры */}
                <div>
                  <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Параметры</label>
                  <input
                    type="text"
                ...
                <div className="mt-4 p-4 bg-white dark:bg-dark-3 rounded-lg border border-stroke dark:border-dark-3">
                  ...
                  {formData.component === 'Website' && (
                    <ul className="text-sm text-body-color dark:text-dark-6 space-y-1">
                      <li>
                        • <strong>View:</strong> page (отдельная страница), home (главная)
                      </li>
                      <li>
                        • <strong>Параметры:</strong> slug=about, id=123
                      </li>
                    </ul>
                  )}
                  {formData.component === 'Store' && (
                    <ul className="text-sm text-body-color dark:text-dark-6 space-y-1">
                      <li>
                        • <strong>View:</strong> categories (список), category (конкретная категория)
                      </li>
                      <li>
                        • <strong>Параметры:</strong> category_id=5, featured=true
                      </li>
                    </ul>
                  )}
                  {formData.component === 'Blog' && (
                    <ul className="text-sm text-body-color dark:text-dark-6 space-y-1">
                      <li>
                        • <strong>View:</strong> list (список статей), article (статья)
                      </li>
                      <li>
                        • <strong>Параметры:</strong> category=news, limit=10
                      </li>
                    </ul>
                  )}
                  {formData.component === 'Landing' && (
                    <ul className="text-sm text-body-color dark:text-dark-6 space-y-1">
                      <li>
                        • <strong>View:</strong> page (лендинг), form (форма)
                      </li>
                      <li>
                        • <strong>Параметры:</strong> template=modern, theme=dark
                      </li>
                    </ul>
                  )}
                </div>
          ...
          {formData.type === 'URL' && (
            <div className="border border-primary/20 dark:border-primary/30 rounded-lg p-6 bg-primary/5 dark:bg-primary/10 mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-lg font-medium text-dark dark:text-white">Внешняя ссылка</h4>
              </div>
              <div>
                <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">URL адрес *</label>
                <input
                  type="url"
          ...
          <div className="border border-primary/20 dark:border-primary/30 rounded-lg p-6 bg-primary/5 dark:bg-primary/10 mb-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-lg font-medium text-dark dark:text-white">Иконка пункта меню</h4>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            {/* Права доступа */}
            <div>
              <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Уровень доступа</label>
              <div className="relative z-20">
                <select
                ...
                >
                  ...
                  <option value="REGISTERED" className="dark:bg-dark-2">
                    Зарегистрированные
                  </option>
                  <option value="SPECIAL" className="dark:bg-dark-2">
                    Специальный (админы)
                  </option>
                  <option value="CUSTOM" className="dark:bg-dark-2">
                    Пользовательский
                  </option>
                </select>
                <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">
            ...
            {/* Язык */}
            <div>
              <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Язык</label>
              <div className="relative z-20">
                <select
                ...
                >
                  ...
                  <option value="ru-RU" className="dark:bg-dark-2">
                    Русский
                  </option>
                  <option value="en-GB" className="dark:bg-dark-2">
                    English
                  </option>
                  <option value="es-ES" className="dark:bg-dark-2">
                    Español
                  </option>
                </select>
                <span className="absolute top-1/2 right-4 z-10 -translate-y-1/2">
          ...
          <details className="border border-stroke dark:border-dark-3 rounded-lg mb-6">
            ...
            <div className="p-4 border-t border-stroke dark:border-dark-3 space-y-4">
              <div>
                <label className="mb-[10px] block text-base font-medium text-dark dark:text-white">Meta Title</label>
                <input
                  type="text"
