...
const ProjectSelector: React.FC = () => {
  ...
  const [selectedProjectType, setSelectedProjectType] = useState<'website' | 'ecommerce' | 'landing' | 'blog'>(
    'website',
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Header title="Мои проекты" onNewProject={() => setShowCreateModal(true)} />
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  ₽{projectStats.ordersRevenue.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  {projectStats.totalVisitors.toLocaleString()}
                </p>
              </div>
            </div>
          </div>
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4">
              <div className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Создать новый проект</h3>
