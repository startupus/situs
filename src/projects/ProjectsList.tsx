      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Мои проекты</h1>
              <p className="text-gray-600 dark:text-gray-400">Добро пожаловать, {user?.username || user?.email}</p>
            </div>
            <Link
              to="/projects/new"
        ...
        {filteredProjects.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              {searchQuery ? 'Попробуйте изменить критерии поиска' : 'Создайте свой первый сайт с помощью Situs'}
            </p>
            {!searchQuery && (
              <Link
                to="/projects/new"
              ...
              >
                <div className="p-6">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-1">{project.name}</h3>
                      {project.description && (
