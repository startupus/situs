    ...
    options: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M19.4375 16.1563C19.4375 16.0625 19.4375 15.9688 19.4063 15.875L17.9375 11.9063C17.9375 11.875 17.9063 11.875 17.9063 11.8438V3.375C17.9063 2.40625 17.125 1.59375 16.1563 1.59375H3.84375C2.875 1.59375 2.09375 2.375 2.09375 3.375V11.8438C2.09375 11.875 2.0625 11.875 2.0625 11.9063L0.593755 15.875C0.562505 15.9688 0.531255 16.0625 0.562505 16.1563C0.562505 16.1563 0.562505 16.1563 0.562505 16.1875V17.125C0.562505 17.8438 1.15625 18.4375 1.875 18.4375H18.1563C18.875 18.4375 19.4688 17.8438 19.4688 17.125L19.4375 16.1563C19.4375 16.1563 19.4688 16.1563 19.4375 16.1563ZM3.5 3.375C3.5 3.1875 3.65625 3 3.84375 3H16.1563C16.3438 3 16.5 3.15625 16.5 3.375V11.5H3.5V3.375ZM1.96875 17V16.25L3.21875 12.9063H16.8125L18.0625 16.25V17.0313H1.96875V17Z"
              fill=""
            />
            <path
  ...
  return (
    <>
      {filterGroupItems.map((category, categoryIndex) => (
        <div
          key={categoryIndex}
          className="mb-9 rounded-lg border border-stroke bg-white px-8 pb-8 pt-[22px] dark:border-dark-3 dark:bg-dark-2 lg:px-6 xl:px-8"
        >
            ...
            <ul className="pt-6">
              {category.options.map((option, optionIndex) => (
                <li key={optionIndex} className="mb-3">
                  <Link
                    to="#"
                    className="flex items-center gap-3 text-base font-medium text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary"
                  >
