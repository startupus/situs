          ...
          {visiblePages.map((page) => (
            <li key={page} className="px-[6px]">
              <Link
                ...
                className={`${page === 1 ? "bg-primary text-white" : "text-body-color"} flex h-6 min-w-[24px] items-center justify-center rounded-sm px-1 text-base hover:bg-[#EDEFF1] dark:hover:bg-white/5 dark:hover:text-white`}
              >
                {page}
              </Link>
            </li>
