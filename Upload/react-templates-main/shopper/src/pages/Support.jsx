                    ...
                    >
                      <div className="relative">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className="box border-stroke dark:border-dark-3 dark:bg-dark mr-4 flex h-5 w-5 items-center justify-center rounded-sm border bg-white">
                          <span className="text-primary opacity-0 dark:text-white">
                            <svg
                              width="11"
                              height="8"
                              viewBox="0 0 11 8"
