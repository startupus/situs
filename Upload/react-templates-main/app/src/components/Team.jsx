import teamOne from "../assets/images/team/team-03/image-01.jpg";
import teamTwo from "../assets/images/team/team-03/image-02.jpg";
import teamThree from "../assets/images/team/team-03/image-03.jpg";
        ...
        <div className="container mx-auto">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            {teamItems.map((item, index) => (
              <div key={index} className="w-full max-w-[270px] px-4">
