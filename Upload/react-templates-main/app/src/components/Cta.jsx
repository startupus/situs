...
import ctaImage from "../assets/images/cta/mobile-01.svg";
    ...
    <>
      <section className="dark:bg-dark">
        <div className="container mx-auto">
          <div className="relative z-10 overflow-hidden rounded-sm bg-[#c4c4c4] dark:bg-dark-3">
              ...
              <div className="w-full px-4 lg:w-1/2">
                <div className="px-6 py-14 sm:px-10 md:px-[70px] md:py-20 lg:pl-11 lg:pr-0">
                  ...
                  <div className="flex flex-wrap items-center">
                    <Link
                      to="#"
                      className="group my-1 mr-4 inline-flex h-[70px] items-center justify-center rounded-lg bg-white px-5 text-center text-base font-medium text-dark shadow-[0px_5px_18px_0px_rgba(0,0,0,0.08)] transition duration-200 hover:text-primary dark:bg-dark-2 dark:text-white dark:hover:text-primary sm:px-6 md:text-lg"
                    >
                      <span className="mr-4 flex h-11 w-11 items-center justify-center rounded-md bg-dark text-white transition duration-200 group-hover:text-primary dark:bg-white/10 dark:group-hover:text-primary">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                    ...
                    <Link
                      to="#"
                      className="group my-1 inline-flex h-[70px] items-center justify-center rounded-lg px-5 text-center text-base font-medium text-dark transition duration-200 hover:bg-white hover:text-primary dark:text-dark-6 dark:hover:bg-dark-2 dark:hover:text-primary sm:px-6 md:text-lg"
                    >
                      <span className="mr-4">
                        <svg
                          width="24"
