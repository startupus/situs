...
const Switcher = () => {
  ...
  const [, setDarkMode] = useState(colorTheme === "light");
  ...
  return (
    <>
      <div className="shadow-1 dark:shadow-box-dark fixed bottom-10 right-10 flex h-11 w-11 items-center justify-center rounded-sm bg-white dark:bg-dark-3">
        <label
