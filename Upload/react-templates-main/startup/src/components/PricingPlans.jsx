          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            {plans.map((item, index) => (
              <div key={index} className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="shadow-pricing relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke bg-white px-8 py-10 dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
                  ...
                  <Link
                    to={item.button.link}
                    className={`${item.popular ? "border-primary bg-primary text-white hover:bg-primary/90" : "border-stroke bg-transparent text-primary hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3"} block w-full rounded-md border p-3 text-center text-base font-medium text-primary transition`}
                  >
                    {item.button.text}
                  </Link>
