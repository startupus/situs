  ...
  return (
    <>
      ...
      >
          ...
          <div className="right-0 top-0 z-10 h-full w-full lg:absolute lg:w-1/2">
            <div className="flex h-full w-full items-center justify-center">
              <img
                src={videoImage}
                alt="image"
                className="left-0 top-0 h-full w-full object-cover object-center lg:absolute"
              />
              <Link
                to="#"
        ...
        {videoOpen && (
          <div className="z-10000 fixed left-0 top-0 h-full w-full touch-pinch-zoom select-none bg-black/70">
            <button
