...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 overflow-hidden bg-[#090E34] pt-20 lg:pt-[120px]">
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            ...
            {footerMenu.map((group, groupIndex) => (
              <div
                key={groupIndex}
                className={`w-full px-4 sm:w-1/2 xl:w-2/12 ${groupIndex === footerMenu.length - 1 ? "lg:w-4/12" : "lg:w-3/12"}`}
              >
                <div className="mb-10 w-full">
