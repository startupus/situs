                      ...
                      <div className="flex items-center space-x-3">
                        {socialList.map((item, index) => (
                          <Link
                            key={index}
                            to="#"
                            className="flex h-9 w-9 items-center justify-center rounded-md border border-stroke text-body-color hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-dark-6 dark:hover:border-primary dark:hover:text-white"
                          >
                            {item.icon}
                          </Link>
                        ))}
                  ...
                  <div key={index}>
                    ...
                    <div className="relative h-2 w-full rounded-2xl bg-stroke dark:bg-dark-3">
                      <div
                        ...
                        className="absolute left-0 top-0 h-full rounded-2xl bg-primary"
                      ></div>
                    </div>
                  </div>
                ))}
