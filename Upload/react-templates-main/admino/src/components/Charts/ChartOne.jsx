        ...
        <div className="justify-between sm:flex">
          ...
          <div>
            <div className="relative z-20 inline-block rounded-md bg-transparent">
              <select className="outline-hidden relative z-20 inline-flex appearance-none rounded-md border border-stroke bg-transparent py-[5px] pl-3 pr-10 text-base text-body-color dark:border-dark-3 dark:text-dark-6">
