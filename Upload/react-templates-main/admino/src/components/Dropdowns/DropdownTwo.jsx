    ...
    <>
      <div className="relative">
        ...
        <ClickOutside onClick={() => setOpenDropDown(false)}>
          <div
            className={`shadow-card absolute right-0 top-full z-40 w-[200px] space-y-1 rounded-sm border border-stroke bg-white p-2 dark:border-dark-3 dark:bg-dark ${openDropDown ? "block" : "hidden"}`}
          >
