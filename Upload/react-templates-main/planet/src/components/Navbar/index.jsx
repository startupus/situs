                  ...
                  >
                    <ul className="items-center block lg:flex">
                      {navList.map((item, index) =>
                        item.submenuGroup ? (
                          <li key={index} className="relative group lg:py-4">
                            <Link
                              to={item.link}
                              onClick={handleSubmenuToggle}
                              className="text-dark hover:text-primary group-hover:text-primary flex items-center justify-between py-2 text-base font-medium lg:mx-6 lg:inline-flex lg:py-2 2xl:mx-[18px] dark:text-white"
                            >
                              {item.text}
                          ...
                          <li key={index}>
                            <Link
                              to={item.link}
                              className="text-dark hover:text-primary flex justify-between py-2 text-base font-medium lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-[18px] dark:text-white"
                            >
                              {item.text}
                            </Link>
                          </li>
