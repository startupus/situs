import productOne from "../assets/ecom-images/products/featured-products-01/image-01.jpg";
import productTwo from "../assets/ecom-images/products/featured-products-01/image-02.jpg";
import productThree from "../assets/ecom-images/products/featured-products-01/image-03.jpg";
import productFour from "../assets/ecom-images/products/featured-products-01/image-04.jpg";
        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            {productList.map((product, index) => (
              <div
                key={index}
                className={`w-full px-4 ${product.bigColumn ? "lg:w-7/12" : "lg:w-5/12"}`}
              >
