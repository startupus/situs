      ...
      <div className="relative z-20">
        <div className="flex max-w-[200px] justify-end">
          <button
            ...
            className="border-stroke bg-gray-2 dropdown-toggle text-dark dark:border-dark-3 dark:bg-dark-2 relative flex h-[42px] w-[42px] items-center justify-center rounded-full border-[.5px] dark:text-white"
          >
            <svg
              width="22"
              height="22"
