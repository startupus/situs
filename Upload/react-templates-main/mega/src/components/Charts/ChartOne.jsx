...
const ChartOne = () => {
  ...
  return (
    <>
      <div className="mb-10 w-full rounded-lg border border-stroke bg-white px-5 pb-5 pt-[30px] dark:border-dark-3 dark:bg-dark-2 sm:px-[30px]">
        <div className="flex justify-between">
          <div>
            <h3 className="text-xl font-bold leading-none text-dark dark:text-white sm:text-[28px]">
              $35,8K
            </h3>
          ...
          <div>
            <div className="relative z-20 inline-block rounded-md bg-transparent">
              <select className="relative z-20 inline-flex appearance-none rounded-md border border-stroke bg-transparent py-[7px] pl-3 pr-10 text-base text-body-color outline-hidden dark:border-dark-3 dark:text-dark-6">
                <option value="Monthly" className="dark:bg-dark-2">
                  Monthly
                </option>
                <option value="Yearly" className="dark:bg-dark-2">
                  Yearly
                </option>
              </select>
