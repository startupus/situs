    ...
    <>
      <div className="-mx-4 flex flex-wrap">
        {dataStatsList.map((item, index) => (
          <div
            key={index}
            className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/3 2xl:w-1/4"
          >
            <div className="mb-8 rounded-lg border border-stroke bg-white p-6 dark:border-dark-3 dark:bg-dark-2 lg:px-4 xl:px-6">
              ...
              <div className="flex items-end justify-between">
                ...
                <div>
                  <p className="inline-flex items-center text-sm font-medium text-secondary">
                    ...
                    <span className="pl-1">
                      <svg
                        ...
                        className="fill-current"
                      >
                        <path d="M4.35716 2.3925L0.908974 5.745L5.0443e-07 4.86125L5 -5.1656e-07L10 4.86125L9.09103 5.745L5.64284 2.3925L5.64284 10L4.35716 10L4.35716 2.3925Z" />
                      </svg>
                    </span>
                  </p>
                </div>
