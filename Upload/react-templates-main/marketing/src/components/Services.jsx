import imageOne from "../assets/images/services/services-07/image-01.jpg";
import imageTwo from "../assets/images/services/services-07/image-02.jpg";
import imageThree from "../assets/images/services/services-07/image-03.jpg";
            ...
            {serviceList.map((item, index) => (
              <div key={index} className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-10 bg-white dark:bg-dark-2">
                  <Link to={item.button.link} className="block w-full">
                  ...
                  <div className="p-8 sm:p-11 md:p-8 lg:px-6 xl:p-10 2xl:p-11">
                    <h3>
                      <Link
                        to={item.button.link}
                        className="mb-4 block text-lg font-bold text-dark hover:text-primary dark:text-white dark:hover:text-primary sm:text-[22px] sm:leading-[35px]"
                      >
                        {item.title}
                      </Link>
                    </h3>
                    ...
                    <Link
                      to={item.button.link}
                      className="inline-flex items-center text-base text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary"
                    >
                      {item.button.text}
                      <span className="ml-3">
                        <svg
