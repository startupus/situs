...
async function retestConnectionOnRefresh(tabId) {
  ...
  chrome.storage.local.get(["browserConnectorSettings"], async (result) => {
    ...
    try {
      ...
      console.log("DevTools not available for connection status update");
    }
    ...
    try {
      ...
      console.log("DevTools not available for auto-discovery notification");
    }
