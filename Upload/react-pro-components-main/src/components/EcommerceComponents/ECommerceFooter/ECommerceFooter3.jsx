                  ...
                  <div>
                    ...
                    <form className="relative">
                      <input
                        ...
                        className="outline-hidden h-[50px] w-full bg-[#1f2735] pl-5 pr-[125px] text-[#CACBCF] placeholder:text-[#CACBCF]"
                      />
            ...
            <div className="-mx-4 flex flex-wrap items-center justify-center">
              ...
              <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-1/3">
                <div className="mx-auto mb-5 lg:mb-0">
                  <img
                    src="https://cdn.tailgrids.com/1.0/assets/images/ecommerce/footers/footer-03/payment.svg"
                    alt="payment"
