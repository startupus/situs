  ...
  return (
    <>
      <section className="dark:bg-dark">
        <div className="container mx-auto overflow-hidden pb-12 pt-20 lg:pb-[90px] lg:pt-[120px]">
  ...
  return (
    <div>
      <div className="relative mb-5 overflow-hidden rounded-md">
        ...
        {newItem && (
          <span className="absolute right-4 top-4 inline-flex items-center justify-center rounded-sm bg-secondary py-[3px] pl-[10px] pr-2 text-sm font-medium text-white">
            New
            <span className="pl-1">
              <svg
                width="12"
        ...
        {hotItem && (
          <span className="absolute right-4 top-4 inline-flex items-center justify-center rounded-sm bg-red-600 py-[3px] pl-[10px] pr-2 text-sm font-medium text-white">
            Hot
            <span className="pl-1">
              <svg
                width="14"
      ...
      <div className="text-center">
        <h3>
          <a
            href={link}
            className="mb-[5px] text-lg font-semibold text-dark hover:text-primary dark:text-white xs:text-xl"
          >
            {name}
          </a>
        </h3>
