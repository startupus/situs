          ...
          <div className="w-full px-4 xl:w-8/12">
            <div>
              <div className="mb-10 overflow-hidden rounded-[10px] border border-stroke bg-white p-10 shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark">
                ...
                <p className="mb-9 text-body-color dark:text-dark-6">
                ...
                <div className="mb-8 max-w-full overflow-x-auto border-b border-stroke dark:border-dark-3">
                  <table className="w-full table-auto">
                    <thead className="rounded-md border border-blue">
                      <tr className="rounded-md border border-stroke bg-gray-1 text-left dark:border-dark-3 dark:bg-dark-2">
                        <th className="min-w-[370px] px-6 py-[10px] text-base font-medium text-dark dark:text-white">
                          Product Details
                        </th>
                        <th className="min-w-[120px] px-4 py-[10px] text-base font-medium text-dark dark:text-white">
                          Quantity
                        </th>
                        <th className="min-w-[120px] px-4 py-[10px] text-base font-medium text-dark dark:text-white">
                          Price
            ...
            <div>
              <div className="overflow-hidden rounded-[10px] border border-stroke bg-white p-10 shadow-testimonial-6 dark:border-dark-3 dark:bg-dark-2 dark:shadow-box-dark">
                ...
                <div className="space-y-8">
                  ...
                  <button className="mb-5 mr-5 flex w-full items-center justify-center rounded-md bg-primary px-8 py-[13px] text-center text-base font-medium text-white hover:bg-blue-dark">
                    Edit Details
                  </button>
                </div>
              </div>
...
const ProductItem = ({ img, link, title, color, size, number, price }) => {
  return (
    <tr>
      <td className="border-t border-stroke py-6 pl-5 pr-4 dark:border-dark-3 sm:pl-6">
        <div className="flex items-center">
          ...
          <div>
            <a
              href={link}
              className="mb-[5px] inline-block text-base font-medium text-dark hover:text-primary dark:text-white"
            >
              {title}
            </a>
