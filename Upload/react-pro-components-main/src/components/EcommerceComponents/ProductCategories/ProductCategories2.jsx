  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      <div className="relative z-10 mb-10">
        ...
        <div className="bg-linear-to-b absolute bottom-0 left-0 flex h-3/4 w-full items-end justify-center from-[#3056D300] to-[#3056D3E5] px-5 py-10">
          <div className="text-center">
            <a
              href={link}
              className="mb-2 block text-xl font-bold text-white hover:text-white/80 sm:text-2xl xl:text-[28px] xl:leading-10"
            >
              {title}
            </a>
            ...
            <button className="inline-flex items-center justify-center rounded-md bg-white px-7 py-[10px] text-center text-base font-medium text-dark hover:bg-gray-4">
              {button}
            </button>
          </div>
        </div>
