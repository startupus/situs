...
const AttentionAlert1 = () => {
  return (
    <div className="bg-white py-10 dark:bg-dark">
      <div className="container">
        <div className="shadow-1 flex w-full rounded-lg border-l-[6px] border-transparent bg-white px-7 py-8 dark:bg-dark-2 md:p-9">
          <div className="mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md bg-yellow/30 text-yellow-dark">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
...
export default AttentionAlert1;
