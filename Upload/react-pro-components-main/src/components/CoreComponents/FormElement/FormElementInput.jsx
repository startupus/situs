  ...
  return (
    <>
      ...
      <input
        ...
        className="outline-hidden w-full rounded-md border border-primary bg-transparent px-5 py-[10px] text-dark-5 transition focus:border-primary active:border-primary disabled:cursor-default disabled:border-gray-2 disabled:bg-gray-2"
      />
    </>
  );
};
  ...
  return (
    <>
      ...
      <input
        ...
        placeholder="Active Input"
        disabled
        className="outline-hidden w-full rounded-md border border-stroke px-5 py-[10px] text-dark-6 transition focus:border-primary active:border-primary disabled:cursor-default disabled:border-gray-2 disabled:bg-gray-2 dark:border-dark-3 dark:disabled:border-dark-4 dark:disabled:bg-dark-4"
      />
    </>
  );
};
    ...
    <>
      ...
      <div className="relative">
        <input
          ...
          className="outline-hidden w-full rounded-md border border-stroke bg-transparent py-[10px] pl-12 pr-3 text-dark-6 transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3"
        />
  ...
  return (
    <>
      ...
      <div className="flex items-center">
        <span className="h-full rounded-bl-md rounded-tl-md border border-r-0 border-stroke bg-gray-2 px-4 py-[10px] text-base uppercase text-body-color dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6">
          USD
        </span>
        <input
          type="text"
          placeholder="Pimjo Labs"
          className="outline-hidden w-full rounded-br-md rounded-tr-md border border-stroke bg-transparent py-[10px] pl-5 pr-3 text-dark-6 transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3"
        />
      </div>
    </>
  );
    ...
    <>
      ...
      <div className="relative">
        <input
          type="email"
          placeholder="Devid Jhon"
          className="outline-hidden w-full rounded-md border border-red bg-transparent py-[10px] pl-5 pr-12 text-dark-6 transition"
        />
    ...
    <>
      ...
      <div className="relative">
        <input
          type="email"
          placeholder="Devid Jhon"
          className="outline-hidden w-full rounded-md border border-green bg-transparent px-12 py-[10px] text-dark-6 transition"
        />
        <span className="absolute left-4 top-1/2 -translate-y-1/2">
          <svg
            width={20}
