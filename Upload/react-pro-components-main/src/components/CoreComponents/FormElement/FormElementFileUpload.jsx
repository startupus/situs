...
const DefaultFileInput = () => {
  return (
    <>
      ...
      <input
        type="file"
        className="outline-hidden w-full cursor-pointer rounded-md border border-stroke text-dark-6 transition file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke file:bg-gray-2 file:px-5 file:py-3 file:text-body-color file:hover:bg-primary/10 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2 dark:border-dark-3 dark:file:border-dark-3 dark:file:bg-dark-2 dark:file:text-dark-6"
      />
    </>
  );
};
  ...
  return (
    <>
      ...
      <div className="relative">
        <input
          type="file"
          className="outline-hidden w-full rounded-md border border-stroke p-3 text-body-color transition file:mr-4 file:rounded-sm file:border-[.5px] file:border-stroke file:bg-gray-2 file:px-[10px] file:py-1 file:text-sm file:font-medium file:text-dark focus:border-primary file:focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6 dark:file:border-dark-3 dark:file:bg-dark-3 dark:file:text-white"
        />
      </div>
    </>
  );
