...
const WhiteOutlineSemiRoundedButtonWithIcon = () => {
  return (
    <button className="inline-flex items-center justify-center rounded-[5px] border border-stroke bg-white px-6 py-3 text-center text-base font-medium text-body-color hover:border-primary hover:text-primary">
