...
const PrimaryOutlineFullRoundedButtonWithIcon = () => {
  return (
    <button className='active:bg-blue-light-3"> inline-flex items-center justify-center rounded-full border border-primary px-7 py-3 text-center text-base font-medium text-primary hover:bg-blue-light-5 hover:text-body-color disabled:border-gray-3 disabled:bg-gray-3 disabled:text-dark-5 dark:hover:text-dark-3'>
