...
const TableTop = () => {
  return (
    <div className="mb-5 rounded-md bg-white px-6 py-4 shadow-2 dark:bg-dark-2">
      <div className="relative">
        <input
          type="text"
          placeholder="Search for user, email address..."
          className="outline-hidden block w-full bg-transparent px-7 text-base text-body-color placeholder:opacity-60 dark:text-dark-6"
        />
        <span className="absolute left-0 top-1/2 -translate-y-1/2 text-body-color dark:text-dark-6">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <button className="absolute right-0 top-1/2 -translate-y-1/2 text-body-color dark:text-dark-6">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
    ...
    <thead>
      <tr className="border-b border-stroke dark:border-dark-3">
        {headers.map((header, index) => (
          <th
            className={`px-4 py-6 first:pl-10 last:pr-10 ${header.styles}`}
            key={index}
          >
            {header.checkbox ? (
              <div className="relative">
                ...
                <label
                  htmlFor="checkbox-1"
                  className="flex cursor-pointer items-center text-base font-medium text-body-color dark:text-dark-6"
                >
                  <span
...
const TableBottom = ({ pagination }) => {
  return (
    <div className="mt-2 flex items-center justify-between border-t border-stroke p-5 dark:border-dark-3 sm:px-6">
      <p className="text-left text-base text-dark dark:text-white">
        {pagination}
      </p>
      <div className="flex items-center justify-end space-x-3">
        <button className="flex h-[30px] w-[30px] items-center justify-center rounded-sm border border-stroke bg-[#FAFBFF] text-body-color hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:bg-dark dark:text-dark-6">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
...
const Checkbox = ({ name, index }) => {
  ...
  return (
    <div className="relative">
      ...
      <label
        htmlFor={index}
        className="flex cursor-pointer items-center text-base font-normal text-body-color dark:text-dark-6"
      >
        <span
          className={`icon-box mr-4 flex h-4 w-4 items-center justify-center rounded-[3px] border-[.5px] text-white ${
            isChecked
