    ...
    <div className="w-full px-3 md:w-1/2">
      <div className="mb-5">
        ...
        <input
          ...
          name={name}
          className="outline-hidden w-full rounded-md border border-stroke bg-transparent px-5 py-3 text-body-color focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
        />
      </div>
    </div>
  );
    ...
    <div className="w-full px-3">
      <div className="mb-8">
        ...
        <textarea
          ...
          placeholder={placeholder}
          name={name}
          className="outline-hidden w-full resize-none rounded-md border border-stroke bg-transparent px-5 py-3 text-body-color focus:border-primary focus-visible:shadow-none dark:border-dark-3 dark:text-dark-6"
