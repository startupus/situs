              ...
              <div className="py-8 text-center">
                <div className="relative mb-8 inline-block text-left">
                  <button
                    ...
                    className={`flex items-center rounded-[5px] bg-secondary px-5 py-[13px] text-base font-medium text-white`}
                  >
                    Dropdown Button
                    <span className="pl-4">
                      <svg
...
const DropdownItem = ({ label, href }) => {
  return (
    <a
      href={href}
      className="block px-5 py-2 text-base text-body-color hover:bg-secondary/5 hover:text-secondary dark:text-dark-6"
    >
      {label}
    </a>
  );
