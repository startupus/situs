              ...
              <div className="py-8 text-center">
                <div className="relative mb-8 inline-block text-left">
                  <button
                    ...
                    className={`flex items-center rounded-[5px] bg-dark px-5 py-[13px] text-base font-medium text-white dark:bg-dark-2`}
                  >
                    Dropdown Button
                    <span className="pl-4">
                      <svg
                  ...
                  <div
                    className={`absolute left-0 z-40 mt-2 w-full rounded-md bg-dark py-[10px] shadow-1 transition-all dark:bg-dark-2 dark:shadow-box-dark ${
                      dropdownOpen
...
const DropdownItem = ({ label, href }) => {
  return (
    <a
      href={href}
      className="block px-5 py-2 text-base text-dark-5 hover:text-white"
    >
      {label}
    </a>
  );
