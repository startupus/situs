            ...
            <div className="flex flex-wrap items-center justify-between rounded-lg bg-primary px-6 py-8 xs:px-10 md:px-8 lg:px-10">
              ...
              <div className="w-full md:w-5/12 lg:w-1/3">
                <div className="flex items-center space-x-3 md:justify-end">
                  <button className="shadow-1 inline-flex items-center justify-center rounded-md bg-white px-7 py-3 text-center text-base font-medium text-body-color hover:bg-gray-2 hover:text-primary dark:bg-dark-2 dark:text-dark-6 dark:shadow-none">
                    Accept
                  </button>
                  <button
                    onClick={handleHide}
                    className="shadow-card inline-flex h-12 w-12 items-center justify-center rounded-sm bg-white/10 text-center text-base font-semibold text-white hover:bg-white/5"
                  >
                    <svg
                      width="20"
                      height="20"
