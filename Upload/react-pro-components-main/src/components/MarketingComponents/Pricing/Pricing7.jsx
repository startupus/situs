  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="shadow-pricing-5 relative z-10 mb-10 overflow-hidden rounded-xl bg-white px-8 py-10 text-center dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14">
