...
const runAllTests = () => {
  ...
  console.log(`📁 File Existence: ${results.fileExistence.passed}/${results.fileExistence.total} (${Math.round(results.fileExistence.passed/results.fileExistence.total*100)}%)`);
  console.log(`🔧 TypeScript Syntax: ${results.typeScriptSyntax.passed}/${results.typeScriptSyntax.total} (${Math.round(results.typeScriptSyntax.passed/results.typeScriptSyntax.total*100)}%)`);
  console.log(`📝 Index Files: ${results.indexFiles.passed}/${results.indexFiles.total} (${Math.round(results.indexFiles.passed/results.indexFiles.total*100)}%)`);
  console.log(`🏠 Main Index: ${results.mainIndex.passed}/${results.mainIndex.total} (${Math.round(results.mainIndex.passed/results.mainIndex.total*100)}%)`);
  console.log(`🎨 Component Showcase: ${results.componentShowcase.passed}/${results.componentShowcase.total} (${Math.round(results.componentShowcase.passed/results.componentShowcase.total*100)}%)`);
