...
const filesToFix = [
  {
    ...
    fixes: [
      {
        pattern: /renderBlock=\{\(\{ children \}\) =>/g,
        replacement: 'renderBlock={({ children }: { children: any }) =>',
      },
      ...
      {
        pattern: /renderLink=\{\(\{ children, href \}\) =>/g,
        replacement: 'renderLink={({ children, href }: { children: any; href: any }) =>',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fixes: [
      {
        pattern: /const \[pageValues\] = usePageValues\(\)/g,
        replacement: 'const [pageValues] = usePageValues() as [{}, () => void]',
      },
    ],
  },
  {
    ...
    fixes: [
      {
        pattern: /const \{ isAdmin, previewMode \} = useAdminContext\(\)/g,
        replacement: 'const { isAdmin } = useAdminContext()',
      },
      {
        pattern: /renderBlock=\{\(\{ children \}\) =>/g,
        replacement: 'renderBlock={({ children }: { children: any }) =>',
      ...
      {
        pattern: /renderLink=\{\(\{ children, href, attributes \}\) =>/g,
        replacement: 'renderLink={({ children, href, attributes }: { children: any; href: any; attributes: any }) =>',
      },
    ],
  },
  {
    ...
    fixes: [
      ...
      {
        pattern: /previewImageUrl: `\/bricks-preview-images\/custom-hero-unit\.png`,/g,
        replacement: '// previewImageUrl: `/bricks-preview-images/custom-hero-unit.png`,',
      },
    ],
  },
  {
    ...
    fixes: [
      {
        pattern: /getExternalData: \(page, brickProps\) =>/g,
        replacement: 'getExternalData: (page: any, brickProps: any) =>',
      },
  ...
  },
  {
    ...
    fixes: [{ pattern: /author: types\.Author/g, replacement: 'author: any' }],
  },
  {
    file: 'src/components/redaktus/website/Features/Features.tsx',
    fixes: [{ pattern: /renderWrapper=\{\(items\) =>/g, replacement: 'renderWrapper={(items: any) =>' }],
  },
  {
    ...
    fixes: [
      ...
      {
        pattern: /items: \[{ type: blockNames\.FormButton }\],/g,
        replacement: '// items: [{ type: blockNames.FormButton }],',
      },
    ],
  },
  {
    ...
    fixes: [
      ...
      {
        pattern: /renderPlaceholder=\{\(\{ children \}\) =>/g,
        replacement: 'renderPlaceholder={({ children }: { children: any }) =>',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fixes: [{ pattern: /validate: \(value\) =>/g, replacement: '// validate: (value: any) =>' }],
  },
  {
    file: 'src/components/redaktus/website/Spacer/Spacer.tsx',
    fixes: [{ pattern: /rangeOptions: {/g, replacement: '// rangeOptions: {' }],
  },
  {
  ...
  },
  {
    ...
    fixes: [{ pattern: /renderPlaceholder=\{\(props\) =>/g, replacement: 'renderPlaceholder={(props: any) =>' }],
  },
  {
...
const filesToDelete = ['src/components/redaktus/tests/blah.test.tsx'];
