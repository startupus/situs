    ...
    const pages = [
      {
        ...
        metaDescription:
          'Запустите свой стартап с помощью платформы Стартапус. Инструменты, ресурсы и поддержка для успешного развития бизнеса.',
        content: {
          blocks: [
            {
              id: 'hero-1',
              ...
              props: {
                ...
                subtitle:
                  'Платформа предоставляет все необходимые инструменты для создания и развития успешного бизнеса',
          ...
          blocks: [
            {
              ...
              props: {
                title: 'О Стартапус',
                content:
                  'Мы помогаем предпринимателям превращать идеи в успешные бизнесы. Наша платформа предоставляет инструменты, знания и поддержку для каждого этапа развития стартапа.',
              },
            },
          ],
        },
      ...
      },
      {
        ...
        metaDescription:
          'Свяжитесь с командой Стартапус для консультации или сотрудничества. Контактная информация и форма обратной связи.',
        content: {
          blocks: [
            {
              id: 'contacts-1',
      ...
      },
      {
        ...
        metaDescription:
          'Гибкие тарифные планы для стартапов любого размера. Выберите оптимальный план для вашего бизнеса.',
        content: {
          blocks: [
            {
              id: 'pricing-1',
